...
def test_health_response_reports_desktop_capability_fields(monkeypatch):
    ...
    linked_instances_module = ModuleType("routes.linked_instances")
    linked_instances_module.router = APIRouter()
    ...
    monkeypatch.setitem(sys.modules, "routes.linked_instances", linked_instances_module)
