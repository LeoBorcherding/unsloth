 ...
 * We import that helper from `@assistant-ui/core/internal`, which re-exports `MessageRepository`
 * from `runtime/utils/message-repository` via a properly declared package export entry.
 *
