  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        ...
        description: "Serve models from other Unsloth Studio instances, such as a Colab or WSL session, through this server's API with one key. Their models appear as @name/model.",
        name: "Name",
