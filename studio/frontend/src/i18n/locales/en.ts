...
export const en = {
  ...
  benchmark: {
    pageTitle: "Benchmark Model",
    pageDescription: "Evaluate model performance and quality metrics",
    configSectionTitle: "Benchmark Configuration",
    configSectionDescription: "Select a model to benchmark",
    modelLabel: "Model",
    ...
    localDir: "Local dir",
    taskLabel: "Benchmark",
    loadingTasks: "Loading benchmarks...",
    searchTaskPlaceholder: "Search benchmarks...",
    noTasksFound: "No benchmarks found",
    ...
    fewshotNotSupported: "Not supported for this task",
    historySectionTitle: "Benchmark History",
    historySectionDescription: "View results from past benchmark runs",
    history: {
      ...
      perSampleResults: "Per-sample results ({count})",
      noSampleData: "No per-sample data available",
      noResults: "No benchmark results yet",
      ...
      deleteTitle: "Delete benchmark run?",
      deleteDescription:
        "This will permanently delete the benchmark results and all per-sample data.",
      deleteBulkTitle: "Delete selected benchmark runs?",
      deleteBulkDescription:
        "This will permanently delete {count} benchmark runs and all their per-sample data.",
      failedToLoad: "Failed to load benchmark history",
      failedToLoadDetail: "Failed to load run details",
      searchPlaceholder: "Search by task or model...",
      noMatches: "No matching benchmark runs",
      selectRun: "Select benchmark run",
      sortDateDesc: "Date (newest)",
      sortDateAsc: "Date (oldest)",
      sortScoreDesc: "Score (high to low)",
      sortScoreAsc: "Score (low to high)",
      sortTaskAsc: "Task (A-Z)",
      sortModelAsc: "Model (A-Z)",
      selected: "{count} selected",
      graph: "Graph",
      compare: "Compare",
      export: "Export",
      exportError: "Failed to export benchmark runs.",
      done: "Done",
    },
    graph: {
      title: "Graph Benchmark Results",
      description: "Configure and generate a comparison chart from selected benchmark runs.",
      orderLabel: "Run order (use arrows to reorder):",
      ...
      themeCustom: "Custom…",
      customThemePlaceholder: "matplotlib style name",
      bar: "Bar",
      line: "Line",
    ...
    compare: {
      ...
      description: "Side-by-side comparison of {count} benchmark runs.",
      loading: "Loading details... ({loaded}/{total})",
      sampleSummary: "Sample results",
      metricBreakdown: "Metric comparison",
      metric: "Metric",
      failedToLoad: "Failed to load run details",
    },
    guide: {
      step1: "Select a model to benchmark",
      step2: "Run the benchmark",
