  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        ...
        description: "Servi i modelli di altre istanze di Unsloth Studio, come una sessione Colab o WSL, tramite l'API di questo server con una sola chiave. I loro modelli appaiono come @nome/modello.",
        name: "Nome",
        ...
        add: "Collega istanza",
        adding: "Collegamento...",
        empty: "Nessuna istanza collegata.",
        checking: "Verifica...",
        offline: "Offline",
