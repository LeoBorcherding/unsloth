...
export const it = {
  benchmark: {
    pageTitle: "Valuta modello",
    pageDescription: "Valuta le prestazioni e la qualità del modello",
    configSectionTitle: "Configurazione del benchmark",
    configSectionDescription: "Seleziona un modello da valutare",
    modelLabel: "Modello",
    loadingCheckpoints: "Caricamento dei checkpoint…",
    scanningLocalModels: "Ricerca dei modelli locali...",
    ...
    taskLabel: "Benchmark",
    loadingTasks: "Caricamento dei benchmark...",
    searchTaskPlaceholder: "Cerca benchmark...",
    noTasksFound: "Nessun benchmark trovato",
    ...
    runPanel: {
      ...
      failed: "Benchmark non riuscito",
      cancelled: "Benchmark annullato",
    },
    fewshotNotSupported: "Non supportato per questa attività",
    historySectionTitle: "Cronologia dei benchmark",
    historySectionDescription: "Visualizza i risultati delle esecuzioni precedenti",
    history: {
      title: "Cronologia dei benchmark",
      run: "esecuzione",
      runs: "esecuzioni",
      refresh: "Aggiorna",
      back: "Indietro",
      ...
      perSampleResults: "Risultati per campione ({count})",
      noSampleData: "Nessun dato per campione disponibile",
      noResults: "Ancora nessun risultato di benchmark",
      noResponse: "(nessuna risposta)",
      noValidResponse: "(nessuna risposta valida)",
      question: "Domanda:",
      expected: "Atteso:",
      got: "Ottenuto:",
      rawOutput: "Output grezzo:",
      deleteTitle: "Eliminare l'esecuzione del benchmark?",
      deleteDescription:
        "I risultati del benchmark e tutti i dati per campione verranno eliminati definitivamente.",
      deleteBulkTitle: "Eliminare le esecuzioni selezionate?",
      deleteBulkDescription:
        "{count} esecuzioni di benchmark e tutti i relativi dati per campione verranno eliminati definitivamente.",
      failedToLoad: "Impossibile caricare la cronologia dei benchmark",
      failedToLoadDetail: "Impossibile caricare i dettagli dell'esecuzione",
      searchPlaceholder: "Cerca per attività o modello...",
      noMatches: "Nessuna esecuzione corrispondente",
      selectRun: "Seleziona esecuzione del benchmark",
      sortDateDesc: "Data (più recente)",
      sortDateAsc: "Data (meno recente)",
      sortScoreDesc: "Punteggio (dal più alto al più basso)",
      sortScoreAsc: "Punteggio (dal più basso al più alto)",
      sortTaskAsc: "Attività (A-Z)",
      sortModelAsc: "Modello (A-Z)",
      selected: "{count} selezionati",
      graph: "Grafico",
      compare: "Confronta",
      export: "Esporta",
      exportError: "Impossibile esportare le esecuzioni di benchmark.",
      done: "Fatto",
    },
    graph: {
      title: "Grafico dei risultati del benchmark",
      description: "Configura e genera un grafico di confronto a partire dalle esecuzioni selezionate.",
      orderLabel: "Ordine delle esecuzioni (usa le frecce per riordinare):",
      ...
      height: "Altezza (in)",
      theme: "Tema",
      themeUnslothDark: "Unsloth scuro",
      dark: "Scuro",
      light: "Chiaro",
      themeGgplot: "ggplot",
      themeFiveThirtyEight: "FiveThirtyEight",
      themeBmh: "BMH",
      themeGrayscale: "Scala di grigi",
      themeSeaborn: "Seaborn",
      themeSeabornDarkgrid: "Seaborn Dark Grid",
      themeCustom: "Personalizzato…",
      customThemePlaceholder: "nome dello stile matplotlib",
      bar: "Barre",
      line: "Linea",
      groupedBar: "Barre raggruppate",
      radar: "Radar",
      generate: "Genera",
      download: "Scarica PNG",
      generating: "Generazione del grafico...",
    },
    compare: {
      title: "Confronta esecuzioni di benchmark",
      description: "Confronto affiancato di {count} esecuzioni di benchmark.",
      loading: "Caricamento dei dettagli... ({loaded}/{total})",
      sampleSummary: "Risultati dei campioni",
      metricBreakdown: "Confronto delle metriche",
      metric: "Metrica",
      failedToLoad: "Impossibile caricare i dettagli dell'esecuzione",
    },
    guide: {
      step1: "Seleziona un modello da valutare",
      step2: "Esegui il benchmark",
      step3: "Rivedi i risultati",
    },
  },
  composerSettings: {
