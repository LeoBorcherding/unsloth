...
export const it = {
  ...
  settings: {
    ...
    library: {
      ...
      medium: "Media",
      large: "Grande",
      imageLayout: "Schede immagine",
      imageLayoutDescription: "Mantieni la forma di ogni immagine o ritagliale in quadrati uniformi.",
      masonry: "Forma originale",
      square: "Quadrata",
      showCardDates: "Mostra date sulle schede",
      showCardDatesDescription: "Mostra quando ogni file è stato modificato l'ultima volta.",
      browsingSection: "Navigazione",
      startTab: "Apri su",
      startTabDescription: "La scheda con cui si apre la Libreria.",
      suggested: "Suggeriti",
      all: "Tutto",
      sort: "Ordina per",
      sortDescription: "Ordine di file e cartelle. Suggeriti mostra sempre i più recenti.",
      recent: "Più recenti",
      oldest: "Meno recenti",
      name: "Nome",
      suggestedLimit: "Elementi suggeriti",
      suggestedLimitDescription: "Quanti file recenti mostra Suggeriti.",
      tabAuto: "Quando contengono file",
      tabAlways: "Sempre",
      contentSection: "Contenuto",
      contentDescription: "Scegli cosa mostra la Libreria. I file nascosti non vengono eliminati.",
      showChatAttachments: "Allegati delle chat",
      showChatAttachmentsDescription: "File che hai allegato alle chat.",
      showChatToolFiles: "File degli strumenti della chat",
      ...
      reset: "Reimposta impostazioni della Libreria",
      resetDescription: "Riporta ogni opzione qui sopra al valore predefinito.",
      resetButton: "Reimposta",
      resetDone: "Impostazioni della Libreria reimpostate",
      storageSection: "Spazio",
      storageDescription: "Apri una categoria per vedere i file dal più grande e elimina ciò che non ti serve più.",
      ...
      locationMoveFailed: "Impossibile spostare {name}",
      locationFree: "{free} liberi su questa unità",
      locationUnavailable: "Non disponibile. Ricollega la sua unità o reimposta la cartella.",
      locationResetUnavailableTitle: "Reimpostare {name}?",
      locationResetUnavailableDescription: "La sua unità non è collegata. I file in {path} restano su quell'unità e non compariranno nella Libreria finché non li sposti di nuovo.",
      locationLeftBehind: "I file in {path} restano su quell'unità.",
      dataStorage: "Spazio della libreria",
      manageStorage: "Gestisci spazio",
      categoryImages: "Immagini",
      categoryVideos: "Video",
      categoryFineTunes: "Fine-tune",
      itemCountOne: "1 elemento",
      itemCount: "{count} elementi",
      tabsSection: "Schede",
      tabsDescription: "Scegli quali schede mostra la Libreria. Una scheda aperta da un link resta visibile.",
      tabHidden: "Nascosta",
      lastVisited: "Ultima visitata",
    },
    tabs: {
      accounts: "Account",
      general: "Generali",
    ...
    apiKeys: {
      linkedInstances: {
        title: "Istanze collegate",
        description: "Servi i modelli di altre istanze Unsloth, come una sessione Colab o WSL, tramite questa API con una sola chiave. Appaiono come @nome/modello.",
        statusNone: "Nessuna collegata",
        statusOnline: "{online} di {total} online",
        ...
        formHint: "Crea una chiave sull'altra istanza in Impostazioni → API. http semplice funziona su questo computer e nella LAN; gli URL pubblici richiedono https.",
        link: "Collega",
        ...
        actions: "Azioni per {name}",
        copyPrefix: "Copia prefisso del modello",
        copyId: "Copia id del modello",
        remove: "Rimuovi",
        loadError: "Impossibile caricare le istanze collegate.",
        saveError: "Impossibile collegare l'istanza.",
        edit: "Modifica",
        apiKeyKeep: "Lascia vuoto per mantenerla",
        removeTitle: "Rimuovere @{name}?",
        removeDescription: "Le richieste a @{name}/… smetteranno di funzionare e la chiave API salvata verrà eliminata da questo computer. L'altra istanza non viene toccata.",
        details: "Dettagli",
        refresh: "Aggiorna",
        infoUnsloth: "Unsloth",
        infoVersion: "Versione",
        infoInstall: "Installazione",
        infoUpdates: "Aggiornamenti",
        infoUpToDate: "Aggiornato",
        infoUpdateAvailable: "{version} disponibile",
        infoUptime: "Attivo da",
        infoHardware: "Hardware",
        infoNoGpu: "Nessuna GPU segnalata",
        infoCpu: "CPU",
        infoCores: "{count} core",
        infoMemory: "Memoria",
        infoDisk: "Disco",
        ...
        infoCpuOnly: "Solo CPU",
        infoModels: "Modelli",
        infoNoModels: "Nessun modello su questa istanza.",
        infoTunnel: "Tunnel Cloudflare",
        infoLoopback: "Questo computer",
        infoLan: "Rete locale",
        infoPublic: "URL pubblico",
        infoUnknown: "Non segnalato",
        infoError: "Impossibile leggere i dettagli di questa istanza.",
      },
      title: "API",
  ...
  library: {
    tabs: {
      ariaLabel: "Sezioni della Libreria",
      suggested: "Suggeriti",
      favorites: "Preferiti",
      folders: "Cartelle",
      images: "Immagini",
    ...
    empty: {
      suggestedTitle: "La tua libreria è vuota",
      suggestedDescription: "I file che carichi o crei nelle chat compaiono qui.",
      favoritesTitle: "Ancora nessun preferito",
      favoritesDescription: "Aggiungi file ai preferiti per ritrovarli qui velocemente.",
      foldersTitle: "Crea la tua prima cartella",
      foldersDescription: "Crea cartelle per organizzare gli elementi della tua libreria.",
      imagesTitle: "Ancora nessuna immagine",
      imagesDescription: "Le immagini che carichi o generi compaiono qui.",
      ...
      trainModel: "Addestra un modello",
      uploadFiles: "Carica file",
      dropHere: "oppure trascina qui i file",
      noMatchesTitle: "Nessun risultato",
      noMatchesDescription: "Prova un'altra ricerca o rimuovi i filtri.",
      loadErrorTitle: "Impossibile caricare la tua Libreria",
      loadErrorFallback: "Qualcosa è andato storto.",
      tryAgain: "Riprova",
    },
    sections: {
      items: "Elementi",
    ...
    searchFolder: "Cerca nella cartella",
    dropToUpload: "Rilascia per caricare",
    dropToUploadInto: "Rilascia per caricare in «{folder}»",
    ...
    menu: {
      ...
      noFolder: "Libreria (nessuna cartella)",
      deleteFolder: "Elimina cartella",
    },
    reveal: {
      finder: "Mostra nel Finder",
      explorer: "Mostra in Esplora risorse",
      files: "Mostra nella cartella",
    },
    toolbar: {
      filter: "Filtra",
      source: "Origine",
    ...
    modelKind: {
      ...
      loraExport: "Esportazione LoRA",
      mergedExport: "Esportazione unita",
      ggufExport: "Esportazione GGUF",
      model: "Modello",
    },
    dialog: {
      create: "Crea",
      ...
      deleteManyTitle: "Eliminare {count} elementi?",
      deleteManyDescription: "I file vengono eliminati dalla loro posizione. Il contenuto di una cartella eliminata sale di un livello.",
      deleteFolderIntoParent: "Tutto il contenuto viene spostato in «{folder}». Nessun file viene eliminato.",
      deleteFolderIntoLibrary: "Tutto il contenuto viene spostato nella tua Libreria. Nessun file viene eliminato.",
      deleteUpload: "Il file verrà eliminato definitivamente.",
      deleteAttachment: "Verrà rimosso anche dalla chat a cui era allegato.",
      deleteImage: "Verrà rimosso anche dalla tua galleria Immagini.",
      deleteVideo: "Verrà rimosso anche dalla tua galleria Video.",
      deleteAudio: "Verrà rimosso anche dalla tua galleria Audio.",
      deleteSandbox: "Verrà rimosso anche dalla chat che lo ha creato.",
      deleteModel: "Il modello verrà eliminato definitivamente dal disco.",
      unsavedTitle: "Le modifiche non sono state salvate",
    ...
    preview: {
      code: "Codice",
      preview: "Anteprima",
      viewOriginalChat: "Vai alla chat originale",
      viewInImages: "Vedi in Immagini",
      viewInVideo: "Vedi in Video",
      ...
      tooLargeToPreview: "Questo file è troppo grande per l'anteprima. Scaricalo per aprirlo.",
      ...
      location: "Posizione",
      unknown: "Sconosciuto",
      readOnlyUtf16: "Questo file non è testo UTF-16 valido, quindi qui si apre in sola lettura.",
      readOnlyNotUtf8: "Questo file non è testo UTF-8, quindi qui si apre in sola lettura. Alcuni caratteri potrebbero non essere visualizzati correttamente.",
    },
    viewer: {
      scale: "Scala",
      fit: "Adatta",
      ...
      moreActionsFile: "Altre azioni per questo file",
      openImage: "Apri immagine",
      openImageNamed: "Apri immagine: {prompt}",
    ...
    project: {
      ...
      alreadyIn: "Già in {project}",
      addedTo: "Aggiunto a {project}",
      createAndAdd: "Crea e aggiungi",
      addFailedImage: "Impossibile aggiungere l'immagine al progetto",
      addFailedVideo: "Impossibile aggiungere il video al progetto",
      addFailedClip: "Impossibile aggiungere la clip al progetto",
      addFailedFile: "Impossibile aggiungere il file al progetto",
      newProjectImage: "Aggiungi l'immagine a un nuovo progetto",
      newProjectVideo: "Aggiungi il video a un nuovo progetto",
      newProjectClip: "Aggiungi la clip a un nuovo progetto",
      newProjectFile: "Aggiungi il file a un nuovo progetto",
    },
    toast: {
      missingItem: "Quel file non è più nella Libreria",
      moveFailed: "Impossibile spostare",
      movedToFolder: "Spostato in {folder}",
      movedToLibrary: "Spostato nella Libreria",
      folderFallback: "cartella",
      favoritesFailed: "Impossibile aggiornare i preferiti",
      addedToFavorites: "Aggiunto ai preferiti",
      removedFromFavorites: "Rimosso dai preferiti",
      uploadingOne: "Caricamento di {name}…",
      uploadingMany: "Caricamento di {count} file…",
      uploadedOne: "File caricato",
      uploadedMany: "{count} file caricati",
      uploadFailed: "Caricamento non riuscito",
      uploadTooLarge: "{name} supera i 512 MB.",
      readDropsFailed: "Impossibile leggere i file rilasciati",
      ...
      signedOutBeforeFolder: "Disconnesso prima che la cartella venisse creata.",
      signedOutBeforeSave: "Disconnesso prima che la modifica venisse salvata.",
      signedOutBeforeUpload: "Disconnesso prima che il caricamento terminasse.",
      deleteFailed: "Non è stato possibile eliminare alcuni elementi",
      saveFailed: "Impossibile salvare",
      saveNoteFirst: "Salva prima la nota.",
      revealFailed: "Impossibile aprire il gestore file",
      downloadFailed: "Impossibile scaricare {name}",
      downloadManyFailed: "Impossibile scaricare i file",
      downloadingMany: "Download di {count} file",
      downloadingManyDescription: "Se il browser lo chiede, consenti a questo sito di scaricare più file.",
      preparingMany: "Preparazione di {count} file…",
      zipFileName: "File della Libreria",
      nothingToChat: "Ancora niente di cui chattare",
      emptyFolder: "Questa cartella non contiene file.",
      tooLargeOne: "{name} è troppo grande per essere allegato",
      tooLargeMany: "Questi file sono troppo grandi per essere allegati",
      attachedOne: "{count} file allegato",
      attachedMany: "{count} file allegati",
      skippedTooLarge: "{count} troppo grandi per essere allegati.",
      skippedOverLimit: "Altri {count} oltre il limite di {limit} file.",
      chatFilesWaiting: "{count} verranno allegati appena sarà caricato un modello in grado di leggerli.",
      openFilesFailed: "Impossibile aprire i file",
      speechModel: "{name} è un modello vocale",
      speechModelDescription: "Sceglilo dal menu dei modelli nella pagina Audio.",
      noMediaLink: "Il server non ha restituito alcun link per riprodurre questo file.",
      imageNotFound: "Impossibile trovare questa immagine",
      clipNotFound: "Impossibile trovare questa clip",
      notFoundDescription: "L'elemento potrebbe essere stato archiviato o eliminato.",
      imageTooLarge: "Questa immagine è troppo grande da allegare",
      videoTooLarge: "Questo video è troppo grande da allegare",
      attachmentLimit: "Gli allegati della chat sono limitati a {size} MB.",
      attachingImage: "Allegando l'immagine…",
      attachingVideo: "Allegando il video…",
      readImageFailed: "Impossibile leggere l'immagine ({status}).",
