...
export const zhCN = {
  composerSettings: {
    ...
    sendShortcut: "发送快捷键",
    sendMultiline: "多行消息使用 {mod} + Enter",
    sendAlways: "始终使用 {mod} + Enter",
    sendEnterDescription: "按 Enter 发送，按 Shift + Enter 换行。",
    sendMultilineDescription: "单行消息按 Enter 发送。消息超过一行后，按 Enter 换行，按 {mod} + Enter 发送。",
    sendAlwaysDescription: "按 {mod} + Enter 发送，按 Enter 换行。",
    followUp: "后续消息行为",
    followUpDescription: "选择在回复过程中发送消息时的操作。按 {shortcut} 可对单条消息执行相反操作。",
    followUpMultilineShortcut: "{shortcut}（多行消息中为 {multiline}）",
    queue: "排队",
    steer: "调整方向",
  ...
  settings: {
    ...
    library: {
      ...
      large: "大",
      imageLayout: "图片卡片",
      imageLayoutDescription: "保留每张图片的原始比例，或裁剪为统一的正方形。",
      masonry: "原始比例",
      square: "正方形",
      showCardDates: "在卡片上显示日期",
      showCardDatesDescription: "显示每个文件的最后修改时间。",
      browsingSection: "浏览",
      startTab: "默认打开",
      startTabDescription: "打开资料库时显示的标签页。",
      suggested: "推荐",
      all: "全部",
      sort: "排序方式",
      sortDescription: "文件和文件夹的顺序。推荐始终显示最新内容。",
      recent: "最新",
      oldest: "最早",
      name: "名称",
      suggestedLimit: "推荐数量",
      suggestedLimitDescription: "推荐中显示的最近文件数量。",
      tabAuto: "有文件时",
      tabAlways: "始终",
      contentSection: "内容",
      contentDescription: "选择资料库显示的内容。隐藏的文件不会被删除。",
      showChatAttachments: "聊天附件",
      showChatAttachmentsDescription: "你在聊天中附加的文件。",
      showChatToolFiles: "聊天工具文件",
      ...
      reset: "重置资料库设置",
      resetDescription: "将以上所有选项恢复为默认值。",
      resetButton: "重置",
      resetDone: "资料库设置已重置",
      storageSection: "存储空间",
      storageDescription: "打开一个类别即可按大小从大到小查看文件，并删除不再需要的内容。",
      ...
      locationMoveFailed: "无法移动{name}",
      locationFree: "此驱动器可用 {free}",
      locationUnavailable: "不可用。请重新连接其驱动器，或重置该文件夹。",
      locationResetUnavailableTitle: "要重置{name}吗？",
      locationResetUnavailableDescription: "其驱动器未连接。{path} 中的文件会留在该驱动器上，在你将它们移回之前不会显示在资料库中。",
      locationLeftBehind: "{path} 中的文件会留在该驱动器上。",
      dataStorage: "资料库存储",
      manageStorage: "管理存储",
      categoryImages: "图片",
      categoryVideos: "视频",
      categoryFineTunes: "微调模型",
      itemCountOne: "1 项",
      itemCount: "{count} 项",
      tabsSection: "标签页",
      tabsDescription: "选择资料库显示哪些标签页。通过链接打开的标签页仍会显示。",
      tabHidden: "隐藏",
      lastVisited: "上次访问",
    },
    tabs: {
    ...
    apiKeys: {
      linkedInstances: {
        title: "已关联实例",
        description: "通过此 API 用一个密钥提供其他 Unsloth 实例（例如 Colab 或 WSL 会话）的模型，显示为 @name/model。",
        statusNone: "未关联",
        ...
        formHint: "在另一个实例的 设置 → API 中创建密钥。普通 http 仅适用于本机和局域网；公网 URL 需要 https。",
        link: "关联",
        linking: "正在关联…",
        checking: "正在检查…",
        offline: "离线",
        ...
        infoUpdates: "更新",
        infoUpToDate: "已是最新",
        infoUpdateAvailable: "{version} 可用",
        infoUptime: "运行时间",
        infoHardware: "硬件",
        infoNoGpu: "未报告 GPU",
        infoCpu: "CPU",
  ...
  library: {
    ...
    empty: {
      suggestedTitle: "资料库为空",
      suggestedDescription: "你上传的文件或在聊天中创建的文件会显示在这里。",
      favoritesTitle: "还没有收藏",
      favoritesDescription: "将文件加入收藏，即可在这里快速找到。",
      foldersTitle: "创建你的第一个文件夹",
      foldersDescription: "创建文件夹来整理资料库中的内容。",
      imagesTitle: "还没有图像",
      imagesDescription: "你上传或生成的图像会显示在这里。",
      videosTitle: "还没有视频",
      videosDescription: "你上传或生成的视频会显示在这里。",
      audioTitle: "还没有音频",
      ...
      noMatchesDescription: "请尝试其他搜索词或清除筛选条件。",
      loadErrorTitle: "无法加载资料库",
      loadErrorFallback: "出了点问题。",
      tryAgain: "重试",
    },
    sections: {
      items: "项目",
    ...
    searchFolder: "搜索文件夹",
    dropToUpload: "松开即可上传",
    dropToUploadInto: "松开即可上传到“{folder}”",
    ...
    dialog: {
      ...
      deleteManyDescription: "文件会从其存储位置删除。已删除文件夹中的内容会上移一级。",
      deleteFolderIntoParent: "其中的所有内容都会移到“{folder}”。不会删除任何文件。",
      deleteFolderIntoLibrary: "其中的所有内容都会移到你的资料库。不会删除任何文件。",
      deleteUpload: "此操作会永久删除该文件。",
      deleteAttachment: "它也会从所附加的聊天中移除。",
      deleteImage: "它也会从你的图像图库中移除。",
      deleteVideo: "它也会从你的视频图库中移除。",
      deleteAudio: "它也会从你的音频图库中移除。",
      deleteSandbox: "它也会从创建它的聊天中移除。",
      deleteModel: "这会将模型从磁盘中永久删除。",
      unsavedTitle: "你的更改未保存",
    ...
    preview: {
      code: "代码",
      preview: "预览",
      viewOriginalChat: "查看原始聊天",
      viewInImages: "在图像中查看",
      viewInVideo: "在视频中查看",
      viewInAudio: "在音频中查看",
      cannotPreview: "无法在此预览该文件。请下载后打开。",
      noPreview: "此文件类型不支持预览。",
      tooLargeToPreview: "文件过大，无法在此预览。请下载后打开。",
      startWriting: "开始写作…",
      type: "类型",
      baseModel: "基础模型",
      size: "大小",
      location: "位置",
      unknown: "未知",
      readOnlyUtf16: "此文件不是有效的 UTF-16 文本，因此在这里以只读方式打开。",
      readOnlyNotUtf8: "此文件不是 UTF-8 文本，因此在这里以只读方式打开。部分字符可能无法正确显示。",
    },
    viewer: {
      scale: "缩放",
      fit: "适应",
      ...
      moreActionsFile: "此文件的更多操作",
      openImage: "打开图片",
      openImageNamed: "打开图片：{prompt}",
      openVideo: "打开视频",
      untitledImage: "未命名图片",
      untitledVideo: "未命名视频",
    },
    project: {
      ...
      newProject: "新建项目",
      noProjects: "还没有项目",
      alreadyIn: "已在 {project} 中",
      addedTo: "已添加到 {project}",
      createAndAdd: "创建并添加",
      addFailedImage: "无法将图像添加到项目",
      addFailedVideo: "无法将视频添加到项目",
      addFailedClip: "无法将片段添加到项目",
      addFailedFile: "无法将文件添加到项目",
      newProjectImage: "将图像添加到新项目",
      newProjectVideo: "将视频添加到新项目",
      newProjectClip: "将片段添加到新项目",
      newProjectFile: "将文件添加到新项目",
    },
    toast: {
      missingItem: "该文件已不在资料库中",
      moveFailed: "无法移动",
      movedToFolder: "已移到 {folder}",
      movedToLibrary: "已移到资料库",
      folderFallback: "文件夹",
      favoritesFailed: "无法更新收藏",
      ...
      uploadFailed: "上传失败",
      uploadTooLarge: "{name} 超过 512 MB。",
      readDropsFailed: "无法读取拖放的文件",
      createNoteFailed: "无法创建笔记",
      renameFailed: "无法重命名",
      createFolderFailed: "无法创建文件夹",
      signedOutBeforeFolder: "文件夹创建完成前已退出登录。",
      signedOutBeforeSave: "更改保存完成前已退出登录。",
      signedOutBeforeUpload: "上传完成前已退出登录。",
      deleteFailed: "部分项目无法删除",
      saveFailed: "无法保存",
      saveNoteFirst: "请先保存笔记。",
      revealFailed: "无法打开文件管理器",
      downloadFailed: "无法下载 {name}",
      downloadManyFailed: "无法下载这些文件",
      downloadingMany: "正在下载 {count} 个文件",
      downloadingManyDescription: "如果浏览器询问，请允许此网站下载多个文件。",
      preparingMany: "正在准备 {count} 个文件…",
      zipFileName: "资料库文件",
      nothingToChat: "还没有可以聊的内容",
      emptyFolder: "此文件夹中没有文件。",
      tooLargeOne: "{name} 过大，无法附加",
      tooLargeMany: "这些文件过大，无法附加",
      attachedOne: "已附加 {count} 个文件",
      ...
      imageTooLarge: "此图片太大，无法附加",
      videoTooLarge: "此视频太大，无法附加",
      attachmentLimit: "聊天附件的大小上限为 {size} MB。",
      attachingImage: "正在附加图片…",
      attachingVideo: "正在附加视频…",
      readImageFailed: "无法读取图片（{status}）。",
      readVideoFailed: "无法读取视频（{status}）。",
