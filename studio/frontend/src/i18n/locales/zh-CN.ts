...
export const zhCN = {
  benchmark: {
    pageTitle: "对模型进行基准测试",
    pageDescription: "评估模型性能和质量指标",
    configSectionTitle: "基准测试配置",
    configSectionDescription: "选择要进行基准测试的模型",
    modelLabel: "模型",
    loadingCheckpoints: "正在加载检查点…",
    scanningLocalModels: "正在扫描本地模型...",
    failedToLoadLocalModels: "本地模型加载失败",
    loadingModel: "正在加载模型…",
    ...
    localDir: "本地目录",
    taskLabel: "基准测试",
    loadingTasks: "正在加载基准测试...",
    searchTaskPlaceholder: "搜索基准测试...",
    noTasksFound: "未找到基准测试",
    runButton: "运行基准测试",
    batchSizeLabel: "批大小",
    ...
    fewshotNotSupported: "此任务不支持该功能",
    historySectionTitle: "基准测试历史",
    historySectionDescription: "查看过去的基准测试运行结果",
    history: {
      title: "基准测试历史",
      run: "次",
      runs: "次",
      ...
      perSampleResults: "逐样本结果 ({count})",
      noSampleData: "暂无逐样本数据",
      noResults: "暂无基准测试结果",
      noResponse: "(无响应)",
      noValidResponse: "(无有效响应)",
      question: "问题：",
      expected: "期望：",
      got: "结果：",
      rawOutput: "原始输出：",
      deleteTitle: "删除此次基准测试运行？",
      deleteDescription:
        "这将永久删除该基准测试结果及其所有逐样本数据。",
      deleteBulkTitle: "删除选中的基准测试运行？",
      deleteBulkDescription:
        "这将永久删除 {count} 次基准测试运行及其所有逐样本数据。",
      failedToLoad: "基准测试历史加载失败",
      failedToLoadDetail: "运行详情加载失败",
      searchPlaceholder: "按任务或模型搜索...",
      noMatches: "没有匹配的基准测试运行",
      selectRun: "选择基准测试运行",
      sortDateDesc: "日期（从新到旧）",
      sortDateAsc: "日期（从旧到新）",
      sortScoreDesc: "分数（从高到低）",
      sortScoreAsc: "分数（从低到高）",
      sortTaskAsc: "任务（A-Z）",
      sortModelAsc: "模型（A-Z）",
      selected: "已选 {count} 项",
      graph: "图表",
      compare: "对比",
      export: "导出",
      exportError: "导出基准测试运行失败。",
      done: "完成",
    },
    graph: {
      title: "基准测试结果图表",
      description: "从选中的基准测试运行中配置并生成对比图表。",
      orderLabel: "运行顺序（使用箭头调整）：",
      chartType: "图表类型",
      metric: "指标",
      accuracy: "准确率",
      width: "宽度（英寸）",
      ...
      themeSeabornDarkgrid: "Seaborn 深色网格",
      themeCustom: "自定义…",
      customThemePlaceholder: "matplotlib 样式名称",
      bar: "柱状图",
      line: "折线图",
      groupedBar: "分组柱状图",
      radar: "雷达图",
    ...
    compare: {
      title: "对比基准测试运行",
      description: "并排对比 {count} 次基准测试运行。",
      loading: "正在加载详情... ({loaded}/{total})",
      sampleSummary: "样本结果",
      metricBreakdown: "指标对比",
      metric: "指标",
      failedToLoad: "运行详情加载失败",
    },
    guide: {
      step1: "选择要进行基准测试的模型",
      step2: "运行基准测试",
