...
export const ja = {
  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        title: "リンクされたインスタンス",
        description: "Colab や WSL セッションなど、他の Unsloth インスタンスのモデルを、この API から 1 つのキーで提供します。@name/model として表示されます。",
        statusNone: "リンクなし",
        statusOnline: "{total} 件中 {online} 件オンライン",
        add: "インスタンスを追加",
        name: "名前",
        ...
        formHint: "相手のインスタンスの 設定 → API でキーを作成してください。http はこのマシンと LAN 内でのみ使えます。公開 URL には https が必要です。",
        link: "リンク",
        linking: "リンク中…",
        checking: "確認中…",
        offline: "オフライン",
        ...
        checkAgain: "再確認",
        actions: "{name} の操作",
        copyPrefix: "モデルのプレフィックスをコピー",
        copyId: "モデル ID をコピー",
        remove: "削除",
        loadError: "リンクされたインスタンスを読み込めませんでした。",
        saveError: "インスタンスをリンクできませんでした。",
        edit: "編集",
        ...
        infoUpdates: "アップデート",
        infoUpToDate: "最新",
        infoUpdateAvailable: "{version} が利用可能",
        infoUptime: "稼働時間",
        infoHardware: "ハードウェア",
        infoNoGpu: "GPU は報告されていません",
        infoCpu: "CPU",
        infoCores: "{count} コア",
        infoMemory: "メモリ",
        infoDisk: "ディスク",
        ...
        infoPublic: "公開 URL",
        infoUnknown: "報告なし",
        infoError: "このインスタンスの詳細を読み取れませんでした。",
      },
      title: "API",
