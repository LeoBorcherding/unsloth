...
export const ja = {
  benchmark: {
    pageTitle: "モデルをベンチマーク",
    pageDescription: "モデルの性能と品質指標を評価します",
    configSectionTitle: "ベンチマーク設定",
    configSectionDescription: "ベンチマークするモデルを選択してください",
    modelLabel: "モデル",
    ...
    hfCache: "HF キャッシュ",
    customFolders: "カスタムフォルダー",
    localDir: "ローカルディレクトリ",
    taskLabel: "ベンチマーク",
    loadingTasks: "ベンチマークを読み込み中...",
    searchTaskPlaceholder: "ベンチマークを検索...",
    noTasksFound: "ベンチマークが見つかりません",
    runButton: "ベンチマークを実行",
    ...
    runPanel: {
      ...
      running: "ベンチマークを実行中...",
      connecting: "接続中...",
      complete: "ベンチマークが完了しました",
      failed: "ベンチマークが失敗しました",
      cancelled: "ベンチマークがキャンセルされました",
    },
    fewshotNotSupported: "このタスクではサポートされていません",
    historySectionTitle: "ベンチマーク履歴",
    historySectionDescription: "過去のベンチマーク実行結果を表示します",
    history: {
      title: "ベンチマーク履歴",
      run: "件",
      runs: "件",
      ...
      model: "モデル",
      date: "日付",
      samples: "{count} 件のサンプル",
      shotCount: "{count}-shot",
      perSampleResults: "サンプルごとの結果 ({count})",
      noSampleData: "サンプルごとのデータはありません",
      noResults: "ベンチマーク結果はまだありません",
      noResponse: "(応答なし)",
      noValidResponse: "(有効な応答なし)",
      question: "質問:",
      expected: "期待値:",
      got: "結果:",
      rawOutput: "生の出力:",
      deleteTitle: "ベンチマーク実行を削除しますか?",
      deleteDescription:
        "ベンチマーク結果とすべてのサンプルごとのデータが完全に削除されます。",
      deleteBulkTitle: "選択したベンチマーク実行を削除しますか?",
      deleteBulkDescription:
        "{count} 件のベンチマーク実行とすべてのサンプルごとのデータが完全に削除されます。",
      failedToLoad: "ベンチマーク履歴の読み込みに失敗しました",
      failedToLoadDetail: "実行の詳細の読み込みに失敗しました",
      searchPlaceholder: "タスクまたはモデルで検索...",
      noMatches: "一致するベンチマーク実行はありません",
      selectRun: "ベンチマーク実行を選択",
      sortDateDesc: "日付 (新しい順)",
      sortDateAsc: "日付 (古い順)",
      sortScoreDesc: "スコア (高い順)",
      sortScoreAsc: "スコア (低い順)",
      sortTaskAsc: "タスク (A-Z)",
      sortModelAsc: "モデル (A-Z)",
      selected: "{count} 件選択中",
      graph: "グラフ",
      compare: "比較",
      export: "エクスポート",
      exportError: "ベンチマーク実行のエクスポートに失敗しました。",
      done: "完了",
    },
    graph: {
      title: "ベンチマーク結果をグラフ化",
      description: "選択したベンチマーク実行から比較チャートを設定して生成します。",
      orderLabel: "実行の順序 (矢印で並べ替え):",
      chartType: "チャートの種類",
      metric: "指標",
      accuracy: "精度",
      width: "幅 (インチ)",
      height: "高さ (インチ)",
      theme: "テーマ",
      themeUnslothDark: "Unsloth ダーク",
      dark: "ダーク",
      light: "ライト",
      themeGgplot: "ggplot",
      themeFiveThirtyEight: "FiveThirtyEight",
      themeBmh: "BMH",
      themeGrayscale: "グレースケール",
      themeSeaborn: "Seaborn",
      themeSeabornDarkgrid: "Seaborn ダークグリッド",
      themeCustom: "カスタム…",
      customThemePlaceholder: "matplotlib のスタイル名",
      bar: "棒グラフ",
      line: "折れ線グラフ",
      groupedBar: "グループ化棒グラフ",
      radar: "レーダーチャート",
      generate: "生成",
    ...
    compare: {
      title: "ベンチマーク実行を比較",
      description: "{count} 件のベンチマーク実行を並べて比較します。",
      loading: "詳細を読み込み中... ({loaded}/{total})",
      sampleSummary: "サンプル結果",
      metricBreakdown: "指標の比較",
      metric: "指標",
      failedToLoad: "実行の詳細の読み込みに失敗しました",
    },
    guide: {
      step1: "ベンチマークするモデルを選択します",
      step2: "ベンチマークを実行します",
      step3: "結果を確認します",
    },
  },
