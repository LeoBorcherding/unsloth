...
export const hi = {
  benchmark: {
    pageTitle: "मॉडल बेंचमार्क करें",
    pageDescription: "मॉडल के प्रदर्शन और गुणवत्ता मेट्रिक्स का आकलन करें",
    configSectionTitle: "बेंचमार्क कॉन्फ़िगरेशन",
    configSectionDescription: "बेंचमार्क के लिए एक मॉडल चुनें",
    modelLabel: "मॉडल",
    loadingCheckpoints: "चेकपॉइंट लोड हो रहे हैं…",
    scanningLocalModels: "स्थानीय मॉडलों की जाँच हो रही है...",
    failedToLoadLocalModels: "स्थानीय मॉडल लोड नहीं हो सके",
    loadingModel: "मॉडल लोड हो रहा है…",
    downloadingModel: "मॉडल डाउनलोड हो रहा है…",
    hfCache: "HF कैश",
    customFolders: "कस्टम फ़ोल्डर",
    localDir: "स्थानीय डायरेक्टरी",
    taskLabel: "बेंचमार्क",
    loadingTasks: "बेंचमार्क लोड हो रहे हैं...",
    searchTaskPlaceholder: "बेंचमार्क खोजें...",
    noTasksFound: "कोई बेंचमार्क नहीं मिला",
    ...
    runPanel: {
      ...
      complete: "बेंचमार्क पूरा हुआ",
      failed: "बेंचमार्क विफल हुआ",
      cancelled: "बेंचमार्क रद्द किया गया",
    },
    fewshotNotSupported: "इस टास्क के लिए समर्थित नहीं है",
    historySectionTitle: "बेंचमार्क इतिहास",
    historySectionDescription: "पिछले बेंचमार्क रन के परिणाम देखें",
    history: {
      title: "बेंचमार्क इतिहास",
      run: "रन",
      runs: "रन",
      ...
      perSampleResults: "प्रति-सैंपल परिणाम ({count})",
      noSampleData: "कोई प्रति-सैंपल डेटा उपलब्ध नहीं है",
      noResults: "अभी तक कोई बेंचमार्क परिणाम नहीं है",
      noResponse: "(कोई प्रतिक्रिया नहीं)",
      noValidResponse: "(कोई मान्य प्रतिक्रिया नहीं)",
      question: "प्रश्न:",
      expected: "अपेक्षित:",
      got: "प्राप्त:",
      rawOutput: "रॉ आउटपुट:",
      deleteTitle: "बेंचमार्क रन हटाएँ?",
      deleteDescription:
        "इससे बेंचमार्क के परिणाम और सभी प्रति-सैंपल डेटा स्थायी रूप से हट जाएँगे।",
      deleteBulkTitle: "चयनित बेंचमार्क रन हटाएँ?",
      deleteBulkDescription:
        "इससे {count} बेंचमार्क रन और उनका सारा प्रति-सैंपल डेटा स्थायी रूप से हट जाएगा।",
      failedToLoad: "बेंचमार्क इतिहास लोड नहीं हो सका",
      failedToLoadDetail: "रन का विवरण लोड नहीं हो सका",
      searchPlaceholder: "टास्क या मॉडल के अनुसार खोजें...",
      noMatches: "कोई मेल खाता बेंचमार्क रन नहीं",
      selectRun: "बेंचमार्क रन चुनें",
      sortDateDesc: "तारीख़ (सबसे नई)",
      sortDateAsc: "तारीख़ (सबसे पुरानी)",
      sortScoreDesc: "स्कोर (ज़्यादा से कम)",
      sortScoreAsc: "स्कोर (कम से ज़्यादा)",
      sortTaskAsc: "टास्क (A-Z)",
      sortModelAsc: "मॉडल (A-Z)",
      selected: "{count} चयनित",
      graph: "ग्राफ़",
      compare: "तुलना करें",
      export: "एक्सपोर्ट करें",
      exportError: "बेंचमार्क रन एक्सपोर्ट नहीं हो सके।",
      done: "पूर्ण",
    },
    graph: {
      title: "बेंचमार्क परिणामों का ग्राफ़ बनाएँ",
      description: "चयनित बेंचमार्क रन से तुलना चार्ट कॉन्फ़िगर और जनरेट करें।",
      orderLabel: "रन का क्रम (क्रम बदलने के लिए तीरों का उपयोग करें):",
      ...
      height: "ऊँचाई (इंच)",
      theme: "थीम",
      themeUnslothDark: "Unsloth डार्क",
      dark: "डार्क",
      light: "लाइट",
      themeGgplot: "ggplot",
      ...
      themeSeabornDarkgrid: "Seaborn डार्क ग्रिड",
      themeCustom: "कस्टम…",
      customThemePlaceholder: "matplotlib स्टाइल का नाम",
      bar: "बार",
      line: "लाइन",
      groupedBar: "ग्रुप्ड बार",
      radar: "रडार",
      generate: "जनरेट करें",
      download: "PNG डाउनलोड करें",
      generating: "चार्ट जनरेट हो रहा है...",
    },
    compare: {
      title: "बेंचमार्क रन की तुलना करें",
      description: "{count} बेंचमार्क रन की साथ-साथ तुलना।",
      loading: "विवरण लोड हो रहे हैं... ({loaded}/{total})",
      sampleSummary: "सैंपल परिणाम",
      metricBreakdown: "मेट्रिक तुलना",
      metric: "मेट्रिक",
      failedToLoad: "रन का विवरण लोड नहीं हो सका",
    },
    guide: {
      step1: "बेंचमार्क के लिए एक मॉडल चुनें",
      step2: "बेंचमार्क चलाएँ",
      step3: "परिणामों की समीक्षा करें",
    },
  },
  composerSettings: {
    title: "संदेश लिखना",
