  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        ...
        description: "अन्य Unsloth Studio इंस्टेंस, जैसे Colab या WSL सत्र, के मॉडल इस सर्वर के API से एक ही कुंजी के साथ उपलब्ध कराएँ। उनके मॉडल @name/model के रूप में दिखते हैं।",
        name: "नाम",
        ...
        add: "इंस्टेंस लिंक करें",
        adding: "लिंक हो रहा है...",
        empty: "अभी कोई लिंक किया गया इंस्टेंस नहीं है।",
