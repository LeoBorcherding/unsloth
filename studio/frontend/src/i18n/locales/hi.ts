...
export const hi = {
  ...
  settings: {
    ...
    library: {
      ...
      medium: "मध्यम",
      large: "बड़ा",
      imageLayout: "इमेज कार्ड",
      imageLayoutDescription: "हर इमेज का आकार बनाए रखें, या बराबर वर्गों में क्रॉप करें।",
      masonry: "मूल आकार",
      square: "वर्ग",
      showCardDates: "कार्ड पर तारीख दिखाएं",
      showCardDatesDescription: "दिखाएं कि हर फ़ाइल आखिरी बार कब बदली गई।",
      browsingSection: "ब्राउज़िंग",
      startTab: "इस टैब पर खोलें",
      startTabDescription: "वह टैब जिस पर लाइब्रेरी खुलती है।",
      suggested: "सुझाए गए",
      all: "सभी",
      sort: "इसके अनुसार क्रमबद्ध करें",
      sortDescription: "फ़ाइलों और फ़ोल्डरों का क्रम। सुझाए गए में हमेशा सबसे नई फ़ाइलें दिखती हैं।",
      recent: "सबसे नए",
      oldest: "सबसे पुराने",
      name: "नाम",
      suggestedLimit: "सुझाए गए आइटम",
      suggestedLimitDescription: "सुझाए गए में कितनी हाल की फ़ाइलें दिखें।",
      tabAuto: "जब फ़ाइलें हों",
      tabAlways: "हमेशा",
      contentSection: "सामग्री",
      contentDescription: "चुनें कि लाइब्रेरी क्या दिखाए। छिपी फ़ाइलें हटाई नहीं जातीं।",
      showChatAttachments: "चैट अटैचमेंट",
      showChatAttachmentsDescription: "वे फ़ाइलें जो आपने चैट में अटैच कीं।",
      showChatToolFiles: "चैट टूल की फ़ाइलें",
      showChatToolFilesDescription: "वे फ़ाइलें जो चैट के दौरान कोड और टूल ने बनाईं।",
      showGeneratedMedia: "जनरेट किया गया मीडिया",
      showGeneratedMediaDescription: "इमेज, वीडियो और ऑडियो पेज से बने इमेज, वीडियो और ऑडियो।",
      showFineTunesDescription: "वे मॉडल जिन्हें आपने Unsloth में ट्रेन या एक्सपोर्ट किया।",
      deletingSection: "हटाना",
      confirmDelete: "हटाने से पहले पुष्टि करें",
      confirmDeleteDescription: "लाइब्रेरी से फ़ाइलें और फ़ोल्डर हटाने से पहले पूछें।",
      reset: "लाइब्रेरी सेटिंग्स रीसेट करें",
      resetDescription: "ऊपर के सभी विकल्पों को डिफ़ॉल्ट पर लौटाएं।",
      resetButton: "रीसेट",
      resetDone: "लाइब्रेरी सेटिंग्स रीसेट हो गईं",
      storageSection: "स्टोरेज",
      storageDescription: "किसी श्रेणी को खोलकर उसकी फ़ाइलें सबसे बड़ी से देखें, और जो ज़रूरी नहीं है उसे हटाएं।",
      storageUsed: "लाइब्रेरी {size} इस्तेमाल कर रही है",
      storageDisk: "इस डिस्क पर {total} में से {free} खाली",
      storageEmpty: "लाइब्रेरी में अभी कुछ भी सेव नहीं है।",
      storageHidden: "{size} सामग्री सेटिंग्स में छिपा है",
      storageError: "लाइब्रेरी का स्टोरेज नहीं पढ़ा जा सका।",
      locationsSection: "डिस्क पर फ़ाइलें",
      locationsDescription: "Unsloth हर तरह की फ़ाइल कहाँ रखता है। लाइब्रेरी फ़ोल्डर Unsloth के अंदर लेबल हैं, डिस्क पर फ़ोल्डर नहीं। फ़ाइन-ट्यून और एक्सपोर्ट अपनी जगह रहते हैं, क्योंकि ट्रेनिंग और चैट उन्हें पाथ से ढूँढते हैं।",
      locationUploads: "लाइब्रेरी अपलोड",
      locationExports: "एक्सपोर्ट",
      revealFailed: "फ़ाइल मैनेजर नहीं खुल सका",
      locationReset: "रीसेट करें",
      locationMoveTitle: "{name} को नए फ़ोल्डर में ले जाएँ",
      locationMoveDescription: "कोई भी फ़ोल्डर चुनें। अगर उसमें पहले से फ़ाइलें हैं, तो Unsloth उसके अंदर अपना फ़ोल्डर बनाता है। यहाँ पहले से मौजूद सब कुछ भी साथ जाएगा।",
      locationMoveAction: "यहाँ ले जाएँ",
      locationMoving: "{name} ले जाया जा रहा है…",
      locationMoved: "{name} ले जाया गया",
      locationMoveFailed: "{name} को नहीं ले जाया जा सका",
      locationFree: "इस ड्राइव पर {free} खाली",
      locationUnavailable: "उपलब्ध नहीं। इसकी ड्राइव फिर से जोड़ें, या फ़ोल्डर रीसेट करें।",
      locationResetUnavailableTitle: "{name} रीसेट करें?",
      locationResetUnavailableDescription: "इसकी ड्राइव जुड़ी नहीं है। {path} की फ़ाइलें उसी ड्राइव पर रहेंगी और जब तक आप उन्हें वापस नहीं ले जाते, लाइब्रेरी में नहीं दिखेंगी।",
      locationLeftBehind: "{path} की फ़ाइलें उसी ड्राइव पर रहती हैं।",
      dataStorage: "लाइब्रेरी स्टोरेज",
      manageStorage: "स्टोरेज प्रबंधित करें",
      categoryImages: "इमेज",
      categoryVideos: "वीडियो",
      categoryFineTunes: "फ़ाइन-ट्यून",
      itemCountOne: "1 आइटम",
      itemCount: "{count} आइटम",
      tabsSection: "टैब",
      tabsDescription: "चुनें कि लाइब्रेरी कौन से टैब दिखाए। लिंक से खोला गया टैब फिर भी दिखता है।",
      tabHidden: "छिपा हुआ",
      lastVisited: "पिछली बार देखा गया",
    },
    tabs: {
      accounts: "खाते",
      general: "सामान्य",
    ...
    apiKeys: {
      linkedInstances: {
        title: "लिंक किए गए इंस्टेंस",
        description: "अन्य Unsloth इंस्टेंस, जैसे Colab या WSL सत्र, के मॉडल इस API से एक ही कुंजी के साथ उपलब्ध कराएँ। वे @name/model के रूप में दिखते हैं।",
        statusNone: "कोई लिंक नहीं",
        statusOnline: "{total} में से {online} ऑनलाइन",
        add: "इंस्टेंस जोड़ें",
        name: "नाम",
        namePlaceholder: "colab-1",
        url: "URL",
        urlPlaceholder: "https://example.trycloudflare.com",
        apiKey: "API कुंजी",
        apiKeyPlaceholder: "sk-unsloth-…",
        formHint: "दूसरे इंस्टेंस पर सेटिंग्स → API में कुंजी बनाएँ। सादा http केवल इस मशीन और आपके LAN पर चलता है; सार्वजनिक URL के लिए https ज़रूरी है।",
        link: "लिंक करें",
        ...
        actions: "{name} के लिए कार्रवाइयाँ",
        copyPrefix: "मॉडल प्रीफ़िक्स कॉपी करें",
        copyId: "मॉडल id कॉपी करें",
        remove: "हटाएँ",
        loadError: "लिंक किए गए इंस्टेंस लोड नहीं हो सके।",
        saveError: "इंस्टेंस लिंक नहीं हो सका।",
        edit: "संपादित करें",
        ...
        infoInstall: "इंस्टॉल",
        infoUpdates: "अपडेट",
        infoUpToDate: "अद्यतित",
        infoUpdateAvailable: "{version} उपलब्ध",
        infoUptime: "अपटाइम",
        infoHardware: "हार्डवेयर",
        infoNoGpu: "कोई GPU रिपोर्ट नहीं हुआ",
        infoCpu: "CPU",
        infoCores: "{count} कोर",
        infoMemory: "मेमोरी",
        infoDisk: "डिस्क",
        ...
        infoError: "इस इंस्टेंस का विवरण नहीं पढ़ा जा सका।",
      },
      title: "API",
  ...
  library: {
    ...
    empty: {
      suggestedTitle: "आपकी लाइब्रेरी खाली है",
      suggestedDescription: "आप जो फ़ाइलें अपलोड करते हैं या चैट में बनाते हैं, वे यहाँ दिखती हैं।",
      favoritesTitle: "अभी कोई पसंदीदा नहीं",
      favoritesDescription: "फ़ाइलों को पसंदीदा में जोड़ें ताकि वे यहाँ जल्दी मिल सकें।",
      foldersTitle: "अपना पहला फ़ोल्डर बनाएँ",
      foldersDescription: "अपनी लाइब्रेरी के आइटम व्यवस्थित करने के लिए फ़ोल्डर बनाएँ।",
      imagesTitle: "अभी कोई इमेज नहीं",
      imagesDescription: "आप जो इमेज अपलोड या जनरेट करते हैं, वे यहाँ दिखती हैं।",
      videosTitle: "अभी कोई वीडियो नहीं",
      videosDescription: "आप जो वीडियो अपलोड या जनरेट करते हैं, वे यहाँ दिखते हैं।",
      audioTitle: "अभी कोई ऑडियो नहीं",
      audioDescription: "ऑडियो पेज पर जनरेट की गई स्पीच यहाँ दिखती है।",
      modelsTitle: "अभी कोई फ़ाइन-ट्यून किया गया मॉडल नहीं",
      modelsDescription: "Unsloth में आप जो मॉडल ट्रेन या एक्सपोर्ट करते हैं, वे यहाँ दिखते हैं।",
      createFolder: "फ़ोल्डर बनाएँ",
      generateVideo: "वीडियो जनरेट करें",
      generateAudio: "ऑडियो जनरेट करें",
      trainModel: "मॉडल ट्रेन करें",
      uploadFiles: "फ़ाइलें अपलोड करें",
      dropHere: "या फ़ाइलें यहाँ छोड़ें",
      noMatchesTitle: "कोई मिलान नहीं",
      noMatchesDescription: "कोई दूसरी खोज आज़माएँ या फ़िल्टर हटाएँ।",
      loadErrorTitle: "आपकी लाइब्रेरी लोड नहीं हो सकी",
      loadErrorFallback: "कुछ गलत हो गया।",
    ...
    searchLibrary: "लाइब्रेरी में खोजें",
    searchFolder: "फ़ोल्डर में खोजें",
    dropToUpload: "अपलोड करने के लिए छोड़ें",
    dropToUploadInto: '"{folder}" में अपलोड करने के लिए छोड़ें',
    ...
    menu: {
      ...
      noFolder: "लाइब्रेरी (कोई फ़ोल्डर नहीं)",
      deleteFolder: "फ़ोल्डर हटाएँ",
    },
    reveal: {
      finder: "Finder में दिखाएँ",
      explorer: "Explorer में दिखाएँ",
      files: "फ़ोल्डर में दिखाएँ",
    },
    toolbar: {
      filter: "फ़िल्टर",
      source: "स्रोत",
    ...
    list: {
      ...
      favorite: "पसंदीदा",
      modified: "बदला गया: {time}",
      opened: "खोला गया: {time}",
      modifiedColumn: "बदला गया",
      justNow: "अभी",
    },
    size: {
      bytes: "{value} B",
    ...
    modelKind: {
      ...
      loraExport: "LoRA एक्सपोर्ट",
      mergedExport: "मर्ज किया गया एक्सपोर्ट",
      ggufExport: "GGUF एक्सपोर्ट",
      model: "मॉडल",
    },
    dialog: {
      create: "बनाएँ",
      ...
      deleteManyTitle: "{count} आइटम हटाएँ?",
      deleteManyDescription: "फ़ाइलें अपनी मूल जगह से हटा दी जाती हैं। हटाए गए फ़ोल्डर के अंदर की चीज़ें एक स्तर ऊपर चली जाती हैं।",
      deleteFolderIntoParent: 'अंदर की सारी चीज़ें "{folder}" में चली जाएँगी। कोई फ़ाइल नहीं हटेगी।',
      deleteFolderIntoLibrary: "अंदर की सारी चीज़ें आपकी लाइब्रेरी में चली जाएँगी। कोई फ़ाइल नहीं हटेगी।",
      deleteUpload: "इससे फ़ाइल स्थायी रूप से हट जाएगी।",
      deleteAttachment: "इसे उस चैट से भी हटा दिया जाएगा जिसमें यह अटैच थी।",
      deleteImage: "इसे आपकी इमेज गैलरी से भी हटा दिया जाएगा।",
      deleteVideo: "इसे आपकी वीडियो गैलरी से भी हटा दिया जाएगा।",
      deleteAudio: "इसे आपकी ऑडियो गैलरी से भी हटा दिया जाएगा।",
      deleteSandbox: "इसे उस चैट से भी हटा दिया जाएगा जिसने इसे बनाया था।",
      deleteModel: "इससे मॉडल डिस्क से हमेशा के लिए हट जाएगा।",
      unsavedTitle: "आपके बदलाव सेव नहीं हुए",
    ...
    preview: {
      code: "कोड",
      preview: "प्रीव्यू",
      viewOriginalChat: "मूल चैट देखें",
      viewInImages: "इमेज पेज में देखें",
      viewInVideo: "वीडियो पेज में देखें",
      ...
      tooLargeToPreview: "यह फ़ाइल यहाँ प्रीव्यू के लिए बहुत बड़ी है। इसे खोलने के लिए डाउनलोड करें।",
      ...
      location: "स्थान",
      unknown: "अज्ञात",
      readOnlyUtf16: "यह फ़ाइल मान्य UTF-16 टेक्स्ट नहीं है, इसलिए यहाँ सिर्फ़ पढ़ने के लिए खुलती है।",
      readOnlyNotUtf8: "यह फ़ाइल UTF-8 टेक्स्ट नहीं है, इसलिए यहाँ सिर्फ़ पढ़ने के लिए खुलती है। कुछ अक्षर सही से न दिखें, ऐसा हो सकता है।",
    },
    viewer: {
      scale: "स्केल",
      fit: "फ़िट",
      ...
      moreActionsFile: "इस फ़ाइल के लिए और कार्रवाइयाँ",
      openImage: "इमेज खोलें",
      openImageNamed: "इमेज खोलें: {prompt}",
      openVideo: "वीडियो खोलें",
      untitledImage: "बिना शीर्षक की इमेज",
    ...
    project: {
      ...
      alreadyIn: "पहले से {project} में है",
      addedTo: "{project} में जोड़ा गया",
      createAndAdd: "बनाएँ और जोड़ें",
      addFailedImage: "इमेज को प्रोजेक्ट में नहीं जोड़ा जा सका",
      addFailedVideo: "वीडियो को प्रोजेक्ट में नहीं जोड़ा जा सका",
      addFailedClip: "क्लिप को प्रोजेक्ट में नहीं जोड़ा जा सका",
      addFailedFile: "फ़ाइल को प्रोजेक्ट में नहीं जोड़ा जा सका",
      newProjectImage: "इमेज को नए प्रोजेक्ट में जोड़ें",
      newProjectVideo: "वीडियो को नए प्रोजेक्ट में जोड़ें",
      newProjectClip: "क्लिप को नए प्रोजेक्ट में जोड़ें",
      newProjectFile: "फ़ाइल को नए प्रोजेक्ट में जोड़ें",
    },
    toast: {
      missingItem: "वह फ़ाइल अब लाइब्रेरी में नहीं है",
      moveFailed: "ले जाया नहीं जा सका",
      movedToFolder: "{folder} में ले जाया गया",
      movedToLibrary: "लाइब्रेरी में ले जाया गया",
      folderFallback: "फ़ोल्डर",
      favoritesFailed: "पसंदीदा अपडेट नहीं हो सके",
      addedToFavorites: "पसंदीदा में जोड़ा गया",
      removedFromFavorites: "पसंदीदा से हटाया गया",
      uploadingOne: "{name} अपलोड हो रही है…",
      uploadingMany: "{count} फ़ाइलें अपलोड हो रही हैं…",
      uploadedOne: "फ़ाइल अपलोड हो गई",
      uploadedMany: "{count} फ़ाइलें अपलोड हो गईं",
      uploadFailed: "अपलोड विफल रहा",
      uploadTooLarge: "{name} 512 MB से बड़ी है।",
      readDropsFailed: "छोड़ी गई फ़ाइलें पढ़ी नहीं जा सकीं",
      createNoteFailed: "नोट नहीं बनाया जा सका",
      renameFailed: "नाम नहीं बदला जा सका",
      createFolderFailed: "फ़ोल्डर नहीं बनाया जा सका",
      signedOutBeforeFolder: "फ़ोल्डर बनने से पहले ही साइन आउट हो गया।",
      signedOutBeforeSave: "बदलाव सेव होने से पहले ही साइन आउट हो गया।",
      signedOutBeforeUpload: "अपलोड पूरा होने से पहले ही साइन आउट हो गया।",
      deleteFailed: "कुछ आइटम हटाए नहीं जा सके",
      saveFailed: "सेव नहीं हो सका",
      saveNoteFirst: "पहले नोट सेव करें।",
      revealFailed: "फ़ाइल मैनेजर नहीं खोला जा सका",
      downloadFailed: "{name} डाउनलोड नहीं हो सकी",
      downloadManyFailed: "फ़ाइलें डाउनलोड नहीं हो सकीं",
      downloadingMany: "{count} फ़ाइलें डाउनलोड हो रही हैं",
      downloadingManyDescription: "अगर आपका ब्राउज़र पूछे, तो इस साइट को कई फ़ाइलें डाउनलोड करने की अनुमति दें।",
      preparingMany: "{count} फ़ाइलें तैयार की जा रही हैं…",
      zipFileName: "लाइब्रेरी फ़ाइलें",
      nothingToChat: "अभी चैट करने के लिए कुछ नहीं है",
      emptyFolder: "इस फ़ोल्डर में कोई फ़ाइल नहीं है।",
      tooLargeOne: "{name} अटैच करने के लिए बहुत बड़ी है",
      tooLargeMany: "ये फ़ाइलें अटैच करने के लिए बहुत बड़ी हैं",
      attachedOne: "{count} फ़ाइल अटैच की गई",
      ...
      imageTooLarge: "यह इमेज अटैच करने के लिए बहुत बड़ी है",
      videoTooLarge: "यह वीडियो अटैच करने के लिए बहुत बड़ा है",
      attachmentLimit: "चैट अटैचमेंट की सीमा {size} MB है।",
      attachingImage: "इमेज अटैच की जा रही है…",
      attachingVideo: "वीडियो अटैच किया जा रहा है…",
      readImageFailed: "इमेज पढ़ी नहीं जा सकी ({status})।",
      readVideoFailed: "वीडियो पढ़ा नहीं जा सका ({status})।",
