...
export const fr = {
  ...
  settings: {
    ...
    library: {
      ...
      cardSizeDescription: "Nombre de cartes par ligne.",
      small: "Petite",
      medium: "Moyenne",
      large: "Grande",
      imageLayout: "Cartes d'image",
      imageLayoutDescription: "Conserver la forme de chaque image ou les recadrer en carrés réguliers.",
      masonry: "Forme d'origine",
      square: "Carrée",
      showCardDates: "Afficher les dates sur les cartes",
      showCardDatesDescription: "Indique quand chaque fichier a été modifié pour la dernière fois.",
      browsingSection: "Navigation",
      startTab: "Ouvrir sur",
      startTabDescription: "L'onglet sur lequel la Bibliothèque s'ouvre.",
      suggested: "Suggestions",
      all: "Tout",
      sort: "Trier par",
      sortDescription: "Ordre des fichiers et dossiers. Suggestions affiche toujours les plus récents.",
      recent: "Plus récents",
      oldest: "Plus anciens",
      name: "Nom",
      suggestedLimit: "Éléments suggérés",
      suggestedLimitDescription: "Nombre de fichiers récents affichés dans Suggestions.",
      tabAuto: "Quand ils contiennent des fichiers",
      tabAlways: "Toujours",
      contentSection: "Contenu",
      contentDescription: "Choisissez ce que la Bibliothèque affiche. Les fichiers masqués ne sont pas supprimés.",
      showChatAttachments: "Pièces jointes des discussions",
      showChatAttachmentsDescription: "Fichiers que vous avez joints aux discussions.",
      showChatToolFiles: "Fichiers des outils de discussion",
      ...
      reset: "Réinitialiser les réglages de la Bibliothèque",
      resetDescription: "Rétablir chaque option ci-dessus à sa valeur par défaut.",
      resetButton: "Réinitialiser",
      resetDone: "Réglages de la Bibliothèque réinitialisés",
      storageSection: "Stockage",
      storageDescription: "Ouvrez une catégorie pour voir ses fichiers du plus lourd au plus léger et supprimez ce dont vous n'avez plus besoin.",
      ...
      locationMoveFailed: "Impossible de déplacer {name}",
      locationFree: "{free} libres sur ce lecteur",
      locationUnavailable: "Indisponible. Reconnectez son lecteur ou réinitialisez le dossier.",
      locationResetUnavailableTitle: "Réinitialiser {name} ?",
      locationResetUnavailableDescription: "Son lecteur n'est pas connecté. Les fichiers de {path} restent sur ce lecteur et n'apparaîtront pas dans la Bibliothèque tant que vous ne les aurez pas remis en place.",
      locationLeftBehind: "Les fichiers de {path} restent sur ce lecteur.",
      dataStorage: "Stockage de la bibliothèque",
      ...
      tabsSection: "Onglets",
      tabsDescription: "Choisissez les onglets affichés par la Bibliothèque. Un onglet ouvert depuis un lien reste visible.",
      tabHidden: "Masqué",
      lastVisited: "Dernier visité",
    },
    tabs: {
      accounts: "Comptes",
      general: "Général",
    ...
    apiKeys: {
      linkedInstances: {
        ...
        description: "Servez les modèles d'autres instances Unsloth, comme une session Colab ou WSL, via cette API avec une seule clé. Ils apparaissent sous la forme @nom/modèle.",
        statusNone: "Aucune liée",
        statusOnline: "{online} sur {total} en ligne",
        ...
        formHint: "Créez une clé sur l'autre instance dans Paramètres → API. Le http simple fonctionne sur cette machine et votre réseau local ; les URL publiques exigent https.",
        link: "Lier",
        linking: "Liaison…",
        checking: "Vérification…",
        offline: "Hors ligne",
        ...
        copyPrefix: "Copier le préfixe du modèle",
        copyId: "Copier l'id du modèle",
        remove: "Retirer",
        loadError: "Impossible de charger les instances liées.",
        saveError: "Impossible de lier l'instance.",
        edit: "Modifier",
        ...
        infoUnsloth: "Unsloth",
        infoVersion: "Version",
        infoInstall: "Installation",
        infoUpdates: "Mises à jour",
        infoUpToDate: "À jour",
        infoUpdateAvailable: "{version} disponible",
        infoUptime: "Durée de fonctionnement",
        infoHardware: "Matériel",
        infoNoGpu: "Aucun GPU signalé",
        infoCpu: "CPU",
        infoCores: "{count} cœurs",
        infoMemory: "Mémoire",
        infoDisk: "Disque",
        ...
        infoError: "Impossible de lire les détails de cette instance.",
      },
      title: "API",
  ...
  library: {
    tabs: {
      ariaLabel: "Sections de la Bibliothèque",
      suggested: "Suggestions",
      favorites: "Favoris",
      folders: "Dossiers",
      images: "Images",
    ...
    empty: {
      suggestedTitle: "Votre bibliothèque est vide",
      suggestedDescription: "Les fichiers que vous importez ou créez dans les discussions apparaissent ici.",
      favoritesTitle: "Aucun favori pour l'instant",
      favoritesDescription: "Ajoutez des fichiers à vos favoris pour les retrouver rapidement ici.",
      foldersTitle: "Créez votre premier dossier",
      foldersDescription: "Créez des dossiers pour organiser les éléments de votre bibliothèque.",
      imagesTitle: "Aucune image pour l'instant",
      imagesDescription: "Les images que vous importez ou générez apparaissent ici.",
      ...
      trainModel: "Entraîner un modèle",
      uploadFiles: "Importer des fichiers",
      dropHere: "ou déposez des fichiers ici",
      noMatchesTitle: "Aucun résultat",
      noMatchesDescription: "Essayez une autre recherche ou effacez les filtres.",
      loadErrorTitle: "Impossible de charger votre Bibliothèque",
      loadErrorFallback: "Une erreur s'est produite.",
      tryAgain: "Réessayer",
    },
    sections: {
      items: "Éléments",
    ...
    searchFolder: "Rechercher dans le dossier",
    dropToUpload: "Déposez pour importer",
    dropToUploadInto: "Déposez pour importer dans « {folder} »",
    ...
    menu: {
      ...
      noFolder: "Bibliothèque (aucun dossier)",
      deleteFolder: "Supprimer le dossier",
    },
    reveal: {
      finder: "Afficher dans le Finder",
      explorer: "Afficher dans l'Explorateur",
      files: "Afficher dans le dossier",
    },
    toolbar: {
      filter: "Filtrer",
      source: "Source",
    ...
    modelKind: {
      lora: "LoRA",
      fullFineTune: "Fine-tuning complet",
      loraExport: "Export LoRA",
      mergedExport: "Export fusionné",
      ggufExport: "Export GGUF",
      model: "Modèle",
    },
    dialog: {
      create: "Créer",
      ...
      deleteManyTitle: "Supprimer {count} éléments ?",
      deleteManyDescription: "Les fichiers sont supprimés de leur emplacement d'origine. Le contenu d'un dossier supprimé remonte d'un niveau.",
      deleteFolderIntoParent: "Tout son contenu est déplacé vers « {folder} ». Aucun fichier n'est supprimé.",
      deleteFolderIntoLibrary: "Tout son contenu est déplacé vers votre Bibliothèque. Aucun fichier n'est supprimé.",
      deleteUpload: "Le fichier sera définitivement supprimé.",
      deleteAttachment: "Il sera aussi retiré de la discussion à laquelle il était joint.",
      deleteImage: "Il sera aussi retiré de votre galerie Images.",
      deleteVideo: "Il sera aussi retiré de votre galerie Vidéo.",
      deleteAudio: "Il sera aussi retiré de votre galerie Audio.",
      deleteSandbox: "Il sera aussi retiré de la discussion qui l'a créé.",
      deleteModel: "Le modèle sera définitivement supprimé du disque.",
      unsavedTitle: "Vos modifications n'ont pas été enregistrées",
    ...
    preview: {
      code: "Code",
      preview: "Aperçu",
      viewOriginalChat: "Voir la discussion d'origine",
      viewInImages: "Voir dans Images",
      viewInVideo: "Voir dans Vidéo",
      ...
      tooLargeToPreview: "Ce fichier est trop volumineux pour être prévisualisé ici. Téléchargez-le pour l'ouvrir.",
      ...
      unknown: "Inconnu",
      readOnlyUtf16: "Ce fichier n'est pas un texte UTF-16 valide : il s'ouvre donc ici en lecture seule.",
      readOnlyNotUtf8: "Ce fichier n'est pas un texte UTF-8 : il s'ouvre donc ici en lecture seule. Certains caractères peuvent s'afficher incorrectement.",
    },
    viewer: {
      scale: "Échelle",
      fit: "Ajuster",
      ...
      moreActionsFile: "Plus d'actions pour ce fichier",
      openImage: "Ouvrir l'image",
      openImageNamed: "Ouvrir l'image : {prompt}",
    ...
    project: {
      ...
      alreadyIn: "Déjà dans {project}",
      addedTo: "Ajouté à {project}",
      createAndAdd: "Créer et ajouter",
      addFailedImage: "Impossible d'ajouter l'image au projet",
      addFailedVideo: "Impossible d'ajouter la vidéo au projet",
      addFailedClip: "Impossible d'ajouter l'extrait au projet",
      addFailedFile: "Impossible d'ajouter le fichier au projet",
      newProjectImage: "Ajouter l'image à un nouveau projet",
      newProjectVideo: "Ajouter la vidéo à un nouveau projet",
      newProjectClip: "Ajouter l'extrait à un nouveau projet",
      newProjectFile: "Ajouter le fichier à un nouveau projet",
    },
    toast: {
      missingItem: "Ce fichier n'est plus dans la Bibliothèque",
      moveFailed: "Impossible de déplacer",
      movedToFolder: "Déplacé vers {folder}",
      movedToLibrary: "Déplacé vers la Bibliothèque",
      folderFallback: "dossier",
      favoritesFailed: "Impossible de mettre à jour les favoris",
      addedToFavorites: "Ajouté aux favoris",
      removedFromFavorites: "Retiré des favoris",
      uploadingOne: "Importation de {name}…",
      uploadingMany: "Importation de {count} fichiers…",
      uploadedOne: "Fichier importé",
      uploadedMany: "{count} fichiers importés",
      uploadFailed: "Échec de l'importation",
      uploadTooLarge: "{name} dépasse 512 Mo.",
      readDropsFailed: "Impossible de lire les fichiers déposés",
      createNoteFailed: "Impossible de créer la note",
      renameFailed: "Impossible de renommer",
      createFolderFailed: "Impossible de créer le dossier",
      signedOutBeforeFolder: "Déconnecté avant la création du dossier.",
      signedOutBeforeSave: "Déconnecté avant l'enregistrement de la modification.",
      signedOutBeforeUpload: "Déconnecté avant la fin de l'importation.",
      deleteFailed: "Certains éléments n'ont pas pu être supprimés",
      saveFailed: "Impossible d'enregistrer",
      saveNoteFirst: "Enregistrez d'abord la note.",
      revealFailed: "Impossible d'ouvrir le gestionnaire de fichiers",
      downloadFailed: "Impossible de télécharger {name}",
      downloadManyFailed: "Impossible de télécharger les fichiers",
      downloadingMany: "Téléchargement de {count} fichiers",
      downloadingManyDescription: "Si votre navigateur le demande, autorisez ce site à télécharger plusieurs fichiers.",
      preparingMany: "Préparation de {count} fichiers…",
      zipFileName: "Fichiers de la Bibliothèque",
      nothingToChat: "Rien à discuter pour l'instant",
      emptyFolder: "Ce dossier ne contient aucun fichier.",
      tooLargeOne: "{name} est trop volumineux pour être joint",
      tooLargeMany: "Ces fichiers sont trop volumineux pour être joints",
      attachedOne: "{count} fichier joint",
      ...
      noMediaLink: "Le serveur n'a renvoyé aucun lien pour lire ce fichier.",
      imageNotFound: "Impossible de trouver cette image",
      clipNotFound: "Impossible de trouver cet extrait",
      notFoundDescription: "Cet élément a peut-être été archivé ou supprimé.",
      imageTooLarge: "Cette image est trop volumineuse pour être jointe",
      videoTooLarge: "Cette vidéo est trop volumineuse pour être jointe",
      attachmentLimit: "Les pièces jointes du chat sont limitées à {size} Mo.",
      attachingImage: "Ajout de l'image…",
      attachingVideo: "Ajout de la vidéo…",
      readImageFailed: "Impossible de lire l'image ({status}).",
