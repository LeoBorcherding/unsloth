  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        ...
        description: "Servez les modèles d'autres instances Unsloth Studio, comme une session Colab ou WSL, via l'API de ce serveur avec une seule clé. Leurs modèles apparaissent sous la forme @nom/modèle.",
        name: "Nom",
        ...
        add: "Lier l'instance",
        adding: "Liaison...",
        empty: "Aucune instance liée pour le moment.",
        checking: "Vérification...",
        offline: "Hors ligne",
