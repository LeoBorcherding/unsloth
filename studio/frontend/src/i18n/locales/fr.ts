...
export const fr = {
  benchmark: {
    pageTitle: "Évaluer un modèle",
    pageDescription: "Évaluez les performances et la qualité du modèle",
    configSectionTitle: "Configuration du benchmark",
    configSectionDescription: "Sélectionnez un modèle à évaluer",
    modelLabel: "Modèle",
    loadingCheckpoints: "Chargement des checkpoints…",
    scanningLocalModels: "Recherche des modèles locaux...",
    ...
    taskLabel: "Benchmark",
    loadingTasks: "Chargement des benchmarks...",
    searchTaskPlaceholder: "Rechercher des benchmarks...",
    noTasksFound: "Aucun benchmark trouvé",
    ...
    runPanel: {
      ...
      cancelled: "Benchmark annulé",
    },
    fewshotNotSupported: "Non pris en charge pour cette tâche",
    historySectionTitle: "Historique des benchmarks",
    historySectionDescription: "Consultez les résultats des benchmarks précédents",
    history: {
      ...
      perSampleResults: "Résultats par échantillon ({count})",
      noSampleData: "Aucune donnée par échantillon disponible",
      noResults: "Aucun résultat de benchmark pour le moment",
      noResponse: "(aucune réponse)",
      noValidResponse: "(aucune réponse valide)",
      question: "Question :",
      expected: "Attendu :",
      got: "Obtenu :",
      rawOutput: "Sortie brute :",
      deleteTitle: "Supprimer ce benchmark ?",
      deleteDescription:
        "Cette action supprimera définitivement les résultats du benchmark et toutes les données par échantillon.",
      deleteBulkTitle: "Supprimer les benchmarks sélectionnés ?",
      deleteBulkDescription:
        "Cette action supprimera définitivement {count} benchmarks et toutes leurs données par échantillon.",
      failedToLoad: "Échec du chargement de l’historique des benchmarks",
      failedToLoadDetail: "Échec du chargement des détails de l’exécution",
      searchPlaceholder: "Rechercher par tâche ou modèle...",
      noMatches: "Aucun benchmark correspondant",
      selectRun: "Sélectionner un benchmark",
      sortDateDesc: "Date (plus récent)",
      sortDateAsc: "Date (plus ancien)",
      sortScoreDesc: "Score (décroissant)",
      sortScoreAsc: "Score (croissant)",
      sortTaskAsc: "Tâche (A-Z)",
      sortModelAsc: "Modèle (A-Z)",
      selected: "{count} sélectionné(s)",
      graph: "Graphique",
      compare: "Comparer",
      export: "Exporter",
      exportError: "Échec de l’export des benchmarks.",
      done: "Terminé",
    },
    graph: {
      title: "Représenter les résultats des benchmarks",
      description: "Configurez et générez un graphique comparatif à partir des benchmarks sélectionnés.",
      orderLabel: "Ordre des exécutions (utilisez les flèches pour réorganiser) :",
      ...
      height: "Hauteur (in)",
      theme: "Thème",
      themeUnslothDark: "Unsloth sombre",
      dark: "Sombre",
      light: "Clair",
      themeGgplot: "ggplot",
      ...
      customThemePlaceholder: "nom de style matplotlib",
      bar: "Barres",
      line: "Ligne",
    ...
    compare: {
      title: "Comparer des benchmarks",
      description: "Comparaison côte à côte de {count} benchmarks.",
      loading: "Chargement des détails... ({loaded}/{total})",
      sampleSummary: "Résultats des échantillons",
      metricBreakdown: "Comparaison des métriques",
      metric: "Métrique",
      failedToLoad: "Échec du chargement des détails de l’exécution",
    },
    guide: {
      step1: "Sélectionnez un modèle à évaluer",
      step2: "Lancez le benchmark",
      step3: "Consultez les résultats",
    },
  },
  composerSettings: {
