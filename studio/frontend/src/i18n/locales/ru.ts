  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        ...
        description: "Отдавайте модели других экземпляров Unsloth Studio, например сеанса Colab или WSL, через API этого сервера с одним ключом. Их модели отображаются как @имя/модель.",
        name: "Имя",
        ...
        add: "Связать экземпляр",
        adding: "Связывание...",
        empty: "Связанных экземпляров пока нет.",
        checking: "Проверка...",
        offline: "Не в сети",
