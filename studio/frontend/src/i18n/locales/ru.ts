...
export const ru = {
  benchmark: {
    pageTitle: "Оценка модели",
    pageDescription: "Оцените производительность и качество модели",
    configSectionTitle: "Настройка бенчмарка",
    configSectionDescription: "Выберите модель для оценки",
    modelLabel: "Модель",
    loadingCheckpoints: "Загрузка чекпоинтов…",
    scanningLocalModels: "Поиск локальных моделей...",
    ...
    localDir: "Локальная папка",
    taskLabel: "Бенчмарк",
    loadingTasks: "Загрузка бенчмарков...",
    searchTaskPlaceholder: "Поиск бенчмарков...",
    noTasksFound: "Бенчмарки не найдены",
    ...
    runPanel: {
      ...
      complete: "Бенчмарк завершён",
      failed: "Ошибка бенчмарка",
      cancelled: "Бенчмарк отменён",
    },
    fewshotNotSupported: "Не поддерживается для этой задачи",
    historySectionTitle: "История бенчмарков",
    historySectionDescription: "Просмотр результатов прошлых запусков бенчмарков",
    history: {
      title: "История бенчмарков",
      run: "запуск",
      runs: "запуски",
      refresh: "Обновить",
      back: "Назад",
      ...
      shotCount: "{count}-shot",
      perSampleResults: "Результаты по образцам ({count})",
      noSampleData: "Данные по образцам недоступны",
      noResults: "Пока нет результатов бенчмарков",
      noResponse: "(нет ответа)",
      noValidResponse: "(нет корректного ответа)",
      question: "Вопрос:",
      expected: "Ожидалось:",
      got: "Получено:",
      rawOutput: "Необработанный вывод:",
      deleteTitle: "Удалить запуск бенчмарка?",
      deleteDescription:
        "Это приведёт к безвозвратному удалению результатов бенчмарка и всех данных по образцам.",
      deleteBulkTitle: "Удалить выбранные запуски бенчмарков?",
      deleteBulkDescription:
        "Это приведёт к безвозвратному удалению {count} запусков бенчмарков и всех их данных по образцам.",
      failedToLoad: "Не удалось загрузить историю бенчмарков",
      failedToLoadDetail: "Не удалось загрузить детали запуска",
      searchPlaceholder: "Поиск по задаче или модели...",
      noMatches: "Нет подходящих запусков бенчмарков",
      selectRun: "Выбрать запуск бенчмарка",
      sortDateDesc: "Дата (сначала новые)",
      sortDateAsc: "Дата (сначала старые)",
      sortScoreDesc: "Оценка (от высокой к низкой)",
      sortScoreAsc: "Оценка (от низкой к высокой)",
      sortTaskAsc: "Задача (А-Я)",
      sortModelAsc: "Модель (А-Я)",
      selected: "Выбрано: {count}",
      graph: "График",
      compare: "Сравнить",
      export: "Экспорт",
      exportError: "Не удалось экспортировать запуски бенчмарков.",
      done: "Готово",
    },
    graph: {
      title: "График результатов бенчмарка",
      description: "Настройте и создайте сравнительную диаграмму по выбранным запускам бенчмарков.",
      orderLabel: "Порядок запусков (используйте стрелки для изменения порядка):",
      ...
      height: "Высота (дюймы)",
      theme: "Тема",
      themeUnslothDark: "Unsloth Тёмная",
      dark: "Тёмная",
      light: "Светлая",
      themeGgplot: "ggplot",
      themeFiveThirtyEight: "FiveThirtyEight",
      themeBmh: "BMH",
      themeGrayscale: "Оттенки серого",
      themeSeaborn: "Seaborn",
      themeSeabornDarkgrid: "Seaborn с тёмной сеткой",
      themeCustom: "Пользовательская…",
      customThemePlaceholder: "название стиля matplotlib",
      bar: "Столбчатая",
      line: "Линейная",
      groupedBar: "Сгруппированная столбчатая",
      radar: "Радар",
      generate: "Создать",
      download: "Скачать PNG",
      generating: "Создание диаграммы...",
    },
    compare: {
      title: "Сравнение запусков бенчмарков",
      description: "Сравнение {count} запусков бенчмарков рядом друг с другом.",
      loading: "Загрузка деталей... ({loaded}/{total})",
      sampleSummary: "Результаты образцов",
      metricBreakdown: "Сравнение метрик",
      metric: "Метрика",
      failedToLoad: "Не удалось загрузить детали запуска",
    },
    guide: {
      step1: "Выберите модель для оценки",
      step2: "Запустите бенчмарк",
