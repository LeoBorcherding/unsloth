...
export const ru = {
  ...
  settings: {
    ...
    library: {
      ...
      medium: "Средний",
      large: "Большой",
      imageLayout: "Карточки изображений",
      imageLayoutDescription: "Сохранять форму каждого изображения или обрезать до ровных квадратов.",
      masonry: "Исходная форма",
      square: "Квадрат",
      showCardDates: "Показывать даты на карточках",
      showCardDatesDescription: "Показывает, когда файл последний раз менялся.",
      browsingSection: "Просмотр",
      startTab: "Открывать на",
      startTabDescription: "Вкладка, с которой открывается Библиотека.",
      suggested: "Рекомендуемое",
      all: "Все",
      sort: "Сортировка",
      sortDescription: "Порядок файлов и папок. Рекомендуемое всегда показывает самые новые.",
      recent: "Сначала новые",
      oldest: "Сначала старые",
      name: "Имя",
      suggestedLimit: "Элементы в рекомендуемом",
      suggestedLimitDescription: "Сколько недавних файлов показывает Рекомендуемое.",
      tabAuto: "Когда есть файлы",
      tabAlways: "Всегда",
      contentSection: "Содержимое",
      contentDescription: "Выберите, что показывает Библиотека. Скрытые файлы не удаляются.",
      showChatAttachments: "Вложения чатов",
      showChatAttachmentsDescription: "Файлы, которые вы прикрепили к чатам.",
      showChatToolFiles: "Файлы инструментов чата",
      ...
      reset: "Сбросить настройки Библиотеки",
      resetDescription: "Вернуть все параметры выше к значениям по умолчанию.",
      resetButton: "Сбросить",
      resetDone: "Настройки Библиотеки сброшены",
      storageSection: "Хранилище",
      storageDescription: "Откройте категорию, чтобы увидеть файлы от самых больших, и удалите ненужное.",
      storageUsed: "Библиотека занимает {size}",
      storageDisk: "Свободно {free} из {total} на этом диске",
      storageEmpty: "В Библиотеке пока ничего нет.",
      ...
      locationMoveFailed: "Не удалось переместить {name}",
      locationFree: "Свободно {free} на этом диске",
      locationUnavailable: "Недоступно. Подключите диск снова или сбросьте папку.",
      locationResetUnavailableTitle: "Сбросить {name}?",
      locationResetUnavailableDescription: "Диск не подключен. Файлы в {path} останутся на нём и не появятся в библиотеке, пока вы не переместите их обратно.",
      locationLeftBehind: "Файлы в {path} остаются на том диске.",
      dataStorage: "Хранилище библиотеки",
      manageStorage: "Управление хранилищем",
      categoryImages: "Изображения",
      categoryVideos: "Видео",
      categoryFineTunes: "Файнтюны",
      itemCountOne: "Элементов: 1",
      itemCount: "Элементов: {count}",
      tabsSection: "Вкладки",
      tabsDescription: "Выберите, какие вкладки показывает Библиотека. Вкладка, открытая по ссылке, всё равно отображается.",
      tabHidden: "Скрыта",
      lastVisited: "Последняя открытая",
    },
    tabs: {
    ...
    general: {
      ...
      managedProviderUrls: {
        sectionTitle: "Управляемые учётные записи",
        enableLabel: "Локальные и сетевые подключения",
        enableDescription:
          "Разрешить управляемым учётным записям указывать в подключениях локальные или сетевые адреса, например сервер Ollama или llama.cpp на этом компьютере или в вашей локальной сети. По умолчанию выключено, так как это открывает таким записям доступ к службам, работающим на вашем компьютере и в вашей сети.",
        lockedByEnvironment:
          "Задано переменной UNSLOTH_STUDIO_BLOCK_PRIVATE_PROVIDER_URLS=1 на этом сервере: приватные адреса отклоняются для всех учётных записей.",
        loadError:
          "Не удалось загрузить настройки подключений управляемых учётных записей.",
        saveError:
          "Не удалось сохранить настройки подключений управляемых учётных записей.",
      },
      notifications: {
    ...
    chat: {
      ...
      visibilityKeywords:
        "свернуть свёрнуто развернуть развёрнуто открыть закрыть размышления рассуждения вызовы инструментов действия группировать потоковая передача",
      thinking: {
      ...
      tools: {
        ...
        foldIntoThinkingBlocked:
          "Недоступно, пока для вызовов инструментов выбрано «Всегда развёрнуто»: в этом режиме они остаются отдельными строками.",
      },
      webSearch: {
        title: "Веб-поиск",
    ...
    apiKeys: {
      linkedInstances: {
        title: "Связанные экземпляры",
        description: "Отдавайте модели других экземпляров Unsloth, например сеанса Colab или WSL, через этот API с одним ключом. Они отображаются как @имя/модель.",
        statusNone: "Нет связанных",
        statusOnline: "В сети: {online} из {total}",
        ...
        formHint: "Создайте ключ на другом экземпляре в разделе Настройки → API. Обычный http работает на этом компьютере и в локальной сети; для публичных URL нужен https.",
        link: "Связать",
        linking: "Связывание…",
        checking: "Проверка…",
        offline: "Не в сети",
        ...
        copyPrefix: "Копировать префикс модели",
        copyId: "Копировать id модели",
        remove: "Удалить",
        loadError: "Не удалось загрузить связанные экземпляры.",
        saveError: "Не удалось связать экземпляр.",
        edit: "Изменить",
        apiKeyKeep: "Оставьте пустым, чтобы сохранить",
        removeTitle: "Удалить @{name}?",
        removeDescription: "Запросы к @{name}/… перестанут работать, а сохранённый API-ключ будет удалён с этого компьютера. Другой экземпляр не затрагивается.",
        details: "Подробнее",
        refresh: "Обновить",
        infoUnsloth: "Unsloth",
        infoVersion: "Версия",
        infoInstall: "Установка",
        infoUpdates: "Обновления",
        infoUpToDate: "Актуальна",
        infoUpdateAvailable: "Доступна {version}",
        infoUptime: "Время работы",
        infoHardware: "Оборудование",
        infoNoGpu: "GPU не обнаружен",
        infoCpu: "CPU",
        infoCores: "Ядер: {count}",
        infoMemory: "Память",
        infoDisk: "Диск",
        ...
        infoError: "Не удалось получить сведения об этом экземпляре.",
      },
      title: "API",
  ...
  library: {
    ...
    empty: {
      suggestedTitle: "Ваша библиотека пуста",
      suggestedDescription: "Здесь появляются файлы, которые вы загружаете или создаёте в чатах.",
      favoritesTitle: "В избранном пока пусто",
      favoritesDescription: "Добавляйте файлы в избранное, чтобы быстро находить их здесь.",
      foldersTitle: "Создайте первую папку",
      foldersDescription: "Создавайте папки, чтобы упорядочить содержимое библиотеки.",
      imagesTitle: "Изображений пока нет",
      imagesDescription: "Здесь появляются изображения, которые вы загружаете или генерируете.",
      videosTitle: "Видео пока нет",
      videosDescription: "Здесь появляются видео, которые вы загружаете или генерируете.",
      ...
      dropHere: "или перетащите файлы сюда",
      noMatchesTitle: "Ничего не найдено",
      noMatchesDescription: "Измените запрос или сбросьте фильтры.",
      loadErrorTitle: "Не удалось загрузить библиотеку",
      loadErrorFallback: "Что-то пошло не так.",
      tryAgain: "Повторить",
    },
    sections: {
      items: "Элементы",
    ...
    dropToUploadInto: "Отпустите, чтобы загрузить в «{folder}»",
    itemCountOne: "Элементов: {count}",
    itemCount: "Элементов: {count}",
    ...
    list: {
      ...
      modified: "Изменено {time}",
      opened: "Открыто {time}",
      modifiedColumn: "Изменено",
      justNow: "только что",
    },
    size: {
      bytes: "{value} Б",
    ...
    modelKind: {
      ...
      loraExport: "Экспорт LoRA",
      mergedExport: "Объединённый экспорт",
      ggufExport: "Экспорт GGUF",
      model: "Модель",
    },
    dialog: {
      create: "Создать",
      ...
      deleteManyTitle: "Удалить элементы ({count})?",
      deleteManyDescription: "Файлы удаляются из места хранения. Содержимое удалённой папки переносится на уровень выше.",
      deleteFolderIntoParent: "Всё содержимое будет перемещено в «{folder}». Файлы не удаляются.",
      deleteFolderIntoLibrary: "Всё содержимое будет перемещено в вашу библиотеку. Файлы не удаляются.",
      deleteUpload: "Файл будет удалён без возможности восстановления.",
      deleteAttachment: "Он также будет удалён из чата, к которому был прикреплён.",
      deleteImage: "Он также будет удалён из вашей галереи изображений.",
      deleteVideo: "Он также будет удалён из вашей галереи видео.",
      deleteAudio: "Он также будет удалён из вашей галереи аудио.",
      deleteSandbox: "Он также будет удалён из чата, в котором был создан.",
      deleteModel: "Модель будет безвозвратно удалена с диска.",
    ...
    preview: {
      code: "Код",
      preview: "Просмотр",
      viewOriginalChat: "Открыть исходный чат",
      viewInImages: "Открыть в «Изображениях»",
      viewInVideo: "Открыть в «Видео»",
      ...
      tooLargeToPreview: "Файл слишком большой для просмотра здесь. Скачайте его, чтобы открыть.",
      ...
      unknown: "Неизвестно",
      readOnlyUtf16: "Этот файл не является корректным текстом в кодировке UTF-16, поэтому здесь он открывается только для чтения.",
      readOnlyNotUtf8: "Этот файл не в кодировке UTF-8, поэтому здесь он открывается только для чтения. Некоторые символы могут отображаться неправильно.",
    },
    viewer: {
      scale: "Масштаб",
      fit: "По размеру",
      ...
      moreActionsFile: "Другие действия с файлом",
      openImage: "Открыть изображение",
      openImageNamed: "Открыть изображение: {prompt}",
      openVideo: "Открыть видео",
      untitledImage: "Изображение без названия",
    ...
    project: {
      ...
      alreadyIn: "Уже в проекте {project}",
      addedTo: "Добавлено в {project}",
      createAndAdd: "Создать и добавить",
      addFailedImage: "Не удалось добавить изображение в проект",
      addFailedVideo: "Не удалось добавить видео в проект",
      addFailedClip: "Не удалось добавить клип в проект",
      addFailedFile: "Не удалось добавить файл в проект",
      newProjectImage: "Добавить изображение в новый проект",
      newProjectVideo: "Добавить видео в новый проект",
      newProjectClip: "Добавить клип в новый проект",
      newProjectFile: "Добавить файл в новый проект",
    },
    toast: {
      missingItem: "Этого файла больше нет в библиотеке",
      moveFailed: "Не удалось переместить",
      movedToFolder: "Перемещено в {folder}",
      movedToLibrary: "Перемещено в библиотеку",
      folderFallback: "папку",
      favoritesFailed: "Не удалось обновить избранное",
      addedToFavorites: "Добавлено в избранное",
      removedFromFavorites: "Удалено из избранного",
      uploadingOne: "Загрузка {name}…",
      uploadingMany: "Загрузка файлов ({count})…",
      uploadedOne: "Файл загружен",
      uploadedMany: "Загружено файлов: {count}",
      uploadFailed: "Не удалось загрузить",
      uploadTooLarge: "Файл {name} больше 512 МБ.",
      readDropsFailed: "Не удалось прочитать перетащенные файлы",
      ...
      signedOutBeforeFolder: "Вы вышли из аккаунта до создания папки.",
      signedOutBeforeSave: "Вы вышли из аккаунта до сохранения изменения.",
      signedOutBeforeUpload: "Вы вышли из аккаунта до завершения загрузки.",
      deleteFailed: "Не удалось удалить некоторые элементы",
      saveFailed: "Не удалось сохранить",
      saveNoteFirst: "Сначала сохраните заметку.",
      revealFailed: "Не удалось открыть файловый менеджер",
      downloadFailed: "Не удалось скачать {name}",
      downloadManyFailed: "Не удалось скачать файлы",
      downloadingMany: "Скачивание файлов ({count})",
      downloadingManyDescription: "Если браузер спросит, разрешите этому сайту скачивать несколько файлов.",
      preparingMany: "Подготовка файлов ({count})…",
      zipFileName: "Файлы библиотеки",
      nothingToChat: "Пока нечего обсуждать",
      emptyFolder: "В этой папке нет файлов.",
      tooLargeOne: "Файл {name} слишком большой для прикрепления",
      tooLargeMany: "Эти файлы слишком большие для прикрепления",
      attachedOne: "Прикреплено файлов: {count}",
      ...
      imageTooLarge: "Это изображение слишком большое для вложения",
      videoTooLarge: "Это видео слишком большое для вложения",
      attachmentLimit: "Размер вложений в чате — не более {size} МБ.",
      attachingImage: "Прикрепляем изображение…",
      attachingVideo: "Прикрепляем видео…",
      readImageFailed: "Не удалось прочитать изображение ({status}).",
      readVideoFailed: "Не удалось прочитать видео ({status}).",
