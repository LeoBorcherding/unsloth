...
export const ar = {
  ...
  settings: {
    ...
    library: {
      ...
      medium: "متوسط",
      large: "كبير",
      imageLayout: "بطاقات الصور",
      imageLayoutDescription: "الاحتفاظ بشكل كل صورة أو قصها إلى مربعات متساوية.",
      masonry: "الشكل الأصلي",
      square: "مربع",
      showCardDates: "إظهار التواريخ على البطاقات",
      showCardDatesDescription: "إظهار آخر وقت تغيّر فيه كل ملف.",
      browsingSection: "التصفح",
      startTab: "الفتح على",
      startTabDescription: "علامة التبويب التي تفتح عليها المكتبة.",
      suggested: "المقترحة",
      all: "الكل",
      sort: "الترتيب حسب",
      sortDescription: "ترتيب الملفات والمجلدات. تعرض المقترحة دائمًا الأحدث.",
      recent: "الأحدث",
      oldest: "الأقدم",
      name: "الاسم",
      suggestedLimit: "عناصر المقترحة",
      suggestedLimitDescription: "عدد الملفات الحديثة التي تعرضها المقترحة.",
      tabAuto: "عند وجود ملفات",
      tabAlways: "دائمًا",
      contentSection: "المحتوى",
      contentDescription: "اختر ما تعرضه المكتبة. لا تُحذف الملفات المخفية.",
      showChatAttachments: "مرفقات المحادثات",
      showChatAttachmentsDescription: "الملفات التي أرفقتها بالمحادثات.",
      showChatToolFiles: "ملفات أدوات المحادثة",
      showChatToolFilesDescription: "الملفات التي أنشأتها الشيفرة والأدوات أثناء المحادثات.",
      showGeneratedMedia: "الوسائط المولدة",
      showGeneratedMediaDescription: "الصور والفيديو والصوت من صفحات الصور والفيديو والصوت.",
      showFineTunesDescription: "النماذج التي درّبتها أو صدّرتها في Unsloth.",
      deletingSection: "الحذف",
      confirmDelete: "التأكيد قبل الحذف",
      confirmDeleteDescription: "السؤال قبل حذف الملفات والمجلدات من المكتبة.",
      reset: "إعادة ضبط إعدادات المكتبة",
      resetDescription: "إرجاع كل خيار أعلاه إلى قيمته الافتراضية.",
      resetButton: "إعادة ضبط",
      resetDone: "تمت إعادة ضبط إعدادات المكتبة",
      storageSection: "التخزين",
      storageDescription: "افتح فئة لرؤية ملفاتها من الأكبر حجمًا، واحذف ما لم تعد تحتاجه.",
      ...
      locationUploads: "ملفات المكتبة المرفوعة",
      locationExports: "التصديرات",
      revealFailed: "تعذر فتح مدير الملفات",
      locationReset: "إعادة التعيين",
      locationMoveTitle: "نقل {name} إلى مجلد جديد",
      locationMoveDescription: "اختر أي مجلد. إذا كان يحتوي على ملفات بالفعل، ينشئ Unsloth مجلدًا خاصًا به داخله. وسينتقل أيضًا كل ما هو موجود هنا.",
      locationMoveAction: "النقل إلى هنا",
      locationMoving: "جارٍ نقل {name}…",
      locationMoved: "تم نقل {name}",
      locationMoveFailed: "تعذر نقل {name}",
      locationFree: "{free} متاحة على هذا القرص",
      locationUnavailable: "غير متاح. أعد توصيل القرص أو أعد تعيين المجلد.",
      locationResetUnavailableTitle: "إعادة تعيين {name}؟",
      locationResetUnavailableDescription: "القرص غير متصل. ستبقى الملفات في {path} على ذلك القرص ولن تظهر في المكتبة حتى تنقلها مرة أخرى.",
      locationLeftBehind: "تبقى الملفات في {path} على ذلك القرص.",
      dataStorage: "مساحة تخزين المكتبة",
      manageStorage: "إدارة التخزين",
      categoryImages: "الصور",
      categoryVideos: "الفيديو",
      categoryFineTunes: "النماذج المضبوطة",
      itemCountOne: "عنصر واحد",
      itemCount: "{count} عناصر",
      tabsSection: "علامات التبويب",
      tabsDescription: "اختر علامات التبويب التي تعرضها المكتبة. تظل علامة التبويب المفتوحة من رابط ظاهرة.",
      tabHidden: "مخفية",
      lastVisited: "آخر ما تمت زيارته",
    },
    tabs: {
      accounts: "الحسابات",
      general: "عام",
    ...
    apiKeys: {
      linkedInstances: {
        title: "المثيلات المرتبطة",
        description: "قدّم نماذج من مثيلات Unsloth أخرى، مثل جلسة Colab أو WSL، عبر واجهة API هذه بمفتاح واحد. تظهر بالشكل ‎@name/model.",
        statusNone: "لا يوجد ارتباط",
        statusOnline: "{online} من {total} متصل",
        add: "إضافة مثيل",
        name: "الاسم",
        ...
        formHint: "أنشئ مفتاحًا على المثيل الآخر من الإعدادات ← API. يعمل http العادي على هذا الجهاز وشبكتك المحلية فقط؛ وتتطلب عناوين URL العامة https.",
        link: "ربط",
        linking: "جارٍ الربط…",
        checking: "جارٍ التحقق…",
        offline: "غير متصل",
        ...
        copyPrefix: "نسخ بادئة النموذج",
        copyId: "نسخ معرّف النموذج",
        remove: "إزالة",
        loadError: "تعذّر تحميل المثيلات المرتبطة.",
        saveError: "تعذّر ربط المثيل.",
        edit: "تعديل",
        apiKeyKeep: "اتركه فارغًا للإبقاء عليه",
        removeTitle: "إزالة @{name}؟",
        removeDescription: "ستتوقف الطلبات إلى @{name}/… عن العمل، وسيُحذف مفتاح API المحفوظ من هذا الجهاز. لا يتأثر المثيل الآخر.",
        details: "التفاصيل",
        refresh: "تحديث",
        infoUnsloth: "Unsloth",
        infoVersion: "الإصدار",
        infoInstall: "التثبيت",
        infoUpdates: "التحديثات",
        infoUpToDate: "محدَّث",
        infoUpdateAvailable: "{version} متاح",
        infoUptime: "مدة التشغيل",
        infoHardware: "العتاد",
        infoNoGpu: "لم يُبلَّغ عن وحدة GPU",
        infoCpu: "CPU",
        infoCores: "{count} نواة",
        infoMemory: "الذاكرة",
        infoDisk: "القرص",
        ...
        infoError: "تعذّرت قراءة تفاصيل هذا المثيل.",
      },
      title: "API",
  ...
  library: {
    ...
    empty: {
      ...
      suggestedDescription: "تظهر هنا الملفات التي ترفعها أو تنشئها في المحادثات.",
      favoritesTitle: "لا توجد عناصر مفضلة بعد",
      favoritesDescription: "أضف الملفات إلى المفضلة للعثور عليها هنا بسرعة.",
      foldersTitle: "أنشئ أول مجلد لك",
      foldersDescription: "أنشئ مجلدات لتنظيم العناصر في مكتبتك.",
      imagesTitle: "لا توجد صور بعد",
      imagesDescription: "تظهر هنا الصور التي ترفعها أو تنشئها.",
      videosTitle: "لا توجد فيديوهات بعد",
      videosDescription: "تظهر هنا الفيديوهات التي ترفعها أو تنشئها.",
      audioTitle: "لا يوجد صوت بعد",
      audioDescription: "يظهر هنا الكلام الذي تنشئه في صفحة الصوت.",
      modelsTitle: "لا توجد نماذج مضبوطة بعد",
      modelsDescription: "تظهر هنا النماذج التي تدربها أو تصدّرها في Unsloth.",
      createFolder: "إنشاء مجلد",
      generateVideo: "إنشاء فيديو",
      generateAudio: "إنشاء صوت",
      trainModel: "تدريب نموذج",
      uploadFiles: "رفع ملفات",
      dropHere: "أو أفلت الملفات هنا",
      noMatchesTitle: "لا توجد نتائج مطابقة",
      noMatchesDescription: "جرّب بحثًا مختلفًا أو امسح عوامل التصفية.",
      loadErrorTitle: "تعذّر تحميل مكتبتك",
      loadErrorFallback: "حدث خطأ ما.",
    ...
    searchFolder: "البحث في المجلد",
    dropToUpload: "أفلت للرفع",
    dropToUploadInto: 'أفلت للرفع إلى "{folder}"',
    itemCountOne: "عدد العناصر: {count}",
    itemCount: "عدد العناصر: {count}",
    ...
    menu: {
      ...
      newFolder: "مجلد جديد",
      noFolder: "المكتبة (بدون مجلد)",
      deleteFolder: "حذف المجلد",
    },
    reveal: {
      finder: "الإظهار في Finder",
      explorer: "الإظهار في Explorer",
      files: "الإظهار في المجلد",
    },
    toolbar: {
      filter: "تصفية",
      source: "المصدر",
    ...
    modelKind: {
      ...
      loraExport: "تصدير LoRA",
      mergedExport: "تصدير مدمج",
      ggufExport: "تصدير GGUF",
      model: "نموذج",
    },
    dialog: {
      create: "إنشاء",
      ...
      deleteManyTitle: "حذف {count} من العناصر؟",
      deleteManyDescription: "تُحذف الملفات من أماكن حفظها. وينتقل ما بداخل المجلد المحذوف مستوى واحدًا إلى الأعلى.",
      deleteFolderIntoParent: 'ينتقل كل ما بداخله إلى "{folder}". لن يُحذف أي ملف.',
      deleteFolderIntoLibrary: "ينتقل كل ما بداخله إلى مكتبتك. لن يُحذف أي ملف.",
      deleteUpload: "سيؤدي هذا إلى حذف الملف نهائيًا.",
      deleteAttachment: "ستتم إزالته أيضًا من المحادثة التي كان مرفقًا بها.",
      deleteImage: "ستتم إزالته أيضًا من معرض الصور.",
      deleteVideo: "ستتم إزالته أيضًا من معرض الفيديو.",
      deleteAudio: "ستتم إزالته أيضًا من معرض الصوت.",
      deleteSandbox: "ستتم إزالته أيضًا من المحادثة التي أنشأته.",
      deleteModel: "سيؤدي هذا إلى حذف النموذج من القرص نهائيًا.",
      unsavedTitle: "لم تُحفظ تغييراتك",
    ...
    preview: {
      code: "الكود",
      preview: "معاينة",
      viewOriginalChat: "عرض المحادثة الأصلية",
      viewInImages: "العرض في الصور",
      viewInVideo: "العرض في الفيديو",
      ...
      tooLargeToPreview: "هذا الملف أكبر من أن تتم معاينته هنا. نزّله لفتحه.",
      ...
      location: "الموقع",
      unknown: "غير معروف",
      readOnlyUtf16: "هذا الملف ليس نصًا صالحًا بترميز UTF-16، لذا يُفتح هنا للقراءة فقط.",
      readOnlyNotUtf8: "هذا الملف ليس نصًا بترميز UTF-8، لذا يُفتح هنا للقراءة فقط. قد لا تظهر بعض الأحرف بشكل صحيح.",
    },
    viewer: {
      scale: "التكبير",
      fit: "ملاءمة",
      ...
      moreActionsFile: "إجراءات أخرى لهذا الملف",
      openImage: "فتح الصورة",
      openImageNamed: "فتح الصورة: {prompt}",
    ...
    project: {
      ...
      alreadyIn: "موجود بالفعل في {project}",
      addedTo: "تمت الإضافة إلى {project}",
      createAndAdd: "إنشاء وإضافة",
      addFailedImage: "تعذّرت إضافة الصورة إلى المشروع",
      addFailedVideo: "تعذّرت إضافة الفيديو إلى المشروع",
      addFailedClip: "تعذّرت إضافة المقطع إلى المشروع",
      addFailedFile: "تعذّرت إضافة الملف إلى المشروع",
      newProjectImage: "إضافة الصورة إلى مشروع جديد",
      newProjectVideo: "إضافة الفيديو إلى مشروع جديد",
      newProjectClip: "إضافة المقطع إلى مشروع جديد",
      newProjectFile: "إضافة الملف إلى مشروع جديد",
    },
    toast: {
      missingItem: "لم يعد هذا الملف موجودًا في المكتبة",
      moveFailed: "تعذّر النقل",
      movedToFolder: "تم النقل إلى {folder}",
      movedToLibrary: "تم النقل إلى المكتبة",
      folderFallback: "المجلد",
      favoritesFailed: "تعذّر تحديث المفضلة",
      addedToFavorites: "تمت الإضافة إلى المفضلة",
      removedFromFavorites: "تمت الإزالة من المفضلة",
      uploadingOne: "جارٍ رفع {name}…",
      uploadingMany: "جارٍ رفع الملفات ({count})…",
      uploadedOne: "تم رفع الملف",
      uploadedMany: "تم رفع الملفات ({count})",
      uploadFailed: "فشل الرفع",
      uploadTooLarge: "حجم {name} أكبر من 512 م.ب.",
      readDropsFailed: "تعذّرت قراءة الملفات المُفلتة",
      createNoteFailed: "تعذّر إنشاء الملاحظة",
      renameFailed: "تعذّرت إعادة التسمية",
      createFolderFailed: "تعذّر إنشاء المجلد",
      signedOutBeforeFolder: "تم تسجيل الخروج قبل إنشاء المجلد.",
      signedOutBeforeSave: "تم تسجيل الخروج قبل حفظ التغيير.",
      signedOutBeforeUpload: "تم تسجيل الخروج قبل اكتمال الرفع.",
      deleteFailed: "تعذّر حذف بعض العناصر",
      saveFailed: "تعذّر الحفظ",
      saveNoteFirst: "احفظ الملاحظة أولًا.",
      revealFailed: "تعذّر فتح مدير الملفات",
      downloadFailed: "تعذّر تنزيل {name}",
      downloadManyFailed: "تعذّر تنزيل الملفات",
      downloadingMany: "جارٍ تنزيل الملفات ({count})",
      downloadingManyDescription: "إذا طلب متصفحك ذلك، فاسمح لهذا الموقع بتنزيل ملفات متعددة.",
      preparingMany: "جارٍ تجهيز الملفات ({count})…",
      zipFileName: "ملفات المكتبة",
      nothingToChat: "لا يوجد ما يمكن الدردشة حوله بعد",
      emptyFolder: "لا يحتوي هذا المجلد على ملفات.",
      tooLargeOne: "حجم {name} أكبر من أن يُرفق",
      tooLargeMany: "هذه الملفات أكبر من أن تُرفق",
      attachedOne: "تم إرفاق {count} ملف",
      ...
      imageTooLarge: "هذه الصورة أكبر من أن تُرفق",
      videoTooLarge: "هذا الفيديو أكبر من أن يُرفق",
      attachmentLimit: "الحد الأقصى لمرفقات المحادثة {size} ميغابايت.",
      attachingImage: "جارٍ إرفاق الصورة…",
      attachingVideo: "جارٍ إرفاق الفيديو…",
      readImageFailed: "تعذّرت قراءة الصورة ({status}).",
      readVideoFailed: "تعذّرت قراءة الفيديو ({status}).",
