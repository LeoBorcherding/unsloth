...
export const ar = {
  benchmark: {
    pageTitle: "تقييم النموذج",
    pageDescription: "قيّم أداء النموذج ومقاييس الجودة",
    configSectionTitle: "إعداد الاختبار",
    configSectionDescription: "اختر نموذجًا لاختباره",
    modelLabel: "النموذج",
    loadingCheckpoints: "جارٍ تحميل نقاط الحفظ…",
    scanningLocalModels: "جارٍ فحص النماذج المحلية...",
    failedToLoadLocalModels: "تعذّر تحميل النماذج المحلية",
    loadingModel: "جارٍ تحميل النموذج…",
    downloadingModel: "جارٍ تنزيل النموذج…",
    hfCache: "ذاكرة تخزين HF المؤقتة",
    customFolders: "مجلدات مخصصة",
    localDir: "مجلد محلي",
    taskLabel: "الاختبار",
    loadingTasks: "جارٍ تحميل الاختبارات...",
    searchTaskPlaceholder: "ابحث عن اختبارات...",
    noTasksFound: "لم يُعثر على اختبارات",
    ...
    runPanel: {
      ...
      failed: "فشل الاختبار",
      cancelled: "أُلغي الاختبار",
    },
    fewshotNotSupported: "غير مدعوم لهذه المهمة",
    historySectionTitle: "سجل الاختبارات",
    historySectionDescription: "عرض نتائج عمليات الاختبار السابقة",
    history: {
      ...
      perSampleResults: "نتائج كل عينة ({count})",
      noSampleData: "لا توجد بيانات عينات متاحة",
      noResults: "لا توجد نتائج اختبار بعد",
      noResponse: "(لا توجد استجابة)",
      noValidResponse: "(لا توجد استجابة صالحة)",
      question: "السؤال:",
      expected: "المتوقّع:",
      got: "الناتج:",
      rawOutput: "الإخراج الخام:",
      deleteTitle: "حذف تشغيل الاختبار؟",
      deleteDescription:
        "سيؤدي هذا إلى حذف نتائج الاختبار وجميع بيانات العينات بشكل نهائي.",
      deleteBulkTitle: "حذف عمليات تشغيل الاختبار المحددة؟",
      deleteBulkDescription:
        "سيؤدي هذا إلى حذف {count} عملية تشغيل اختبار وجميع بيانات العينات الخاصة بها بشكل نهائي.",
      failedToLoad: "تعذّر تحميل سجل الاختبارات",
      failedToLoadDetail: "تعذّر تحميل تفاصيل التشغيل",
      searchPlaceholder: "ابحث حسب المهمة أو النموذج...",
      noMatches: "لا توجد عمليات تشغيل اختبار مطابقة",
      selectRun: "اختر تشغيل الاختبار",
      sortDateDesc: "التاريخ (الأحدث)",
      sortDateAsc: "التاريخ (الأقدم)",
      sortScoreDesc: "النتيجة (من الأعلى إلى الأدنى)",
      sortScoreAsc: "النتيجة (من الأدنى إلى الأعلى)",
      sortTaskAsc: "المهمة (أ-ي)",
      sortModelAsc: "النموذج (أ-ي)",
      selected: "تم تحديد {count}",
      graph: "رسم بياني",
      compare: "مقارنة",
      export: "تصدير",
      exportError: "تعذّر تصدير عمليات تشغيل الاختبار.",
      done: "تم",
    },
    graph: {
      title: "رسم نتائج الاختبار بيانيًا",
      description: "أعدّ وأنشئ مخططًا مقارنًا من عمليات تشغيل الاختبار المحددة.",
      orderLabel: "ترتيب التشغيل (استخدم الأسهم لإعادة الترتيب):",
      ...
      theme: "السمة",
      themeUnslothDark: "Unsloth داكن",
      dark: "داكن",
      light: "فاتح",
      themeGgplot: "ggplot",
      themeFiveThirtyEight: "FiveThirtyEight",
      themeBmh: "BMH",
      themeGrayscale: "تدرج رمادي",
      themeSeaborn: "Seaborn",
      themeSeabornDarkgrid: "Seaborn بشبكة داكنة",
      themeCustom: "مخصص…",
      customThemePlaceholder: "اسم نمط matplotlib",
      bar: "أعمدة",
      line: "خطي",
      groupedBar: "أعمدة مجمّعة",
      radar: "رادار",
      generate: "إنشاء",
      download: "تنزيل PNG",
    ...
    compare: {
      title: "مقارنة عمليات تشغيل الاختبار",
      description: "مقارنة جنبًا إلى جنب لـ {count} عملية تشغيل اختبار.",
      loading: "جارٍ تحميل التفاصيل... ({loaded}/{total})",
      sampleSummary: "نتائج العينات",
      metricBreakdown: "مقارنة المقاييس",
      metric: "المقياس",
      failedToLoad: "تعذّر تحميل تفاصيل التشغيل",
    },
    guide: {
      step1: "اختر نموذجًا لاختباره",
      step2: "شغّل الاختبار",
      step3: "راجع النتائج",
    },
  },
