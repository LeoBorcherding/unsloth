  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        ...
        description: "قدّم نماذج من مثيلات Unsloth Studio أخرى، مثل جلسة Colab أو WSL، عبر واجهة API لهذا الخادم بمفتاح واحد. تظهر نماذجها بالشكل ‎@name/model.",
        name: "الاسم",
        ...
        add: "ربط المثيل",
        adding: "جارٍ الربط...",
        empty: "لا توجد مثيلات مرتبطة بعد.",
        checking: "جارٍ التحقق...",
        offline: "غير متصل",
