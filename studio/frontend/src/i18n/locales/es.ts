  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        ...
        description: "Sirve modelos de otras instancias de Unsloth Studio, como una sesión de Colab o WSL, a través de la API de este servidor con una sola clave. Sus modelos aparecen como @nombre/modelo.",
        name: "Nombre",
        ...
        add: "Vincular instancia",
        adding: "Vinculando...",
        empty: "Aún no hay instancias vinculadas.",
        checking: "Comprobando...",
