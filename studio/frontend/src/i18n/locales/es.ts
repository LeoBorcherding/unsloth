...
export const es = {
  benchmark: {
    pageTitle: "Evaluar modelo",
    pageDescription: "Evalúa el rendimiento y la calidad del modelo",
    configSectionTitle: "Configuración del benchmark",
    configSectionDescription: "Selecciona un modelo para evaluar",
    modelLabel: "Modelo",
    loadingCheckpoints: "Cargando checkpoints…",
    scanningLocalModels: "Buscando modelos locales...",
    ...
    taskLabel: "Benchmark",
    loadingTasks: "Cargando benchmarks...",
    searchTaskPlaceholder: "Buscar benchmarks...",
    noTasksFound: "No se encontraron benchmarks",
    ...
    runPanel: {
      ...
      failed: "Error en el benchmark",
      cancelled: "Benchmark cancelado",
    },
    fewshotNotSupported: "No compatible con esta tarea",
    historySectionTitle: "Historial de benchmarks",
    historySectionDescription: "Consulta los resultados de ejecuciones anteriores",
    history: {
      title: "Historial de benchmarks",
      run: "ejecución",
      runs: "ejecuciones",
      refresh: "Actualizar",
      back: "Atrás",
      ...
      perSampleResults: "Resultados por muestra ({count})",
      noSampleData: "No hay datos por muestra disponibles",
      noResults: "Aún no hay resultados de benchmarks",
      noResponse: "(sin respuesta)",
      noValidResponse: "(sin respuesta válida)",
      question: "Pregunta:",
      expected: "Esperado:",
      got: "Obtenido:",
      rawOutput: "Salida sin procesar:",
      deleteTitle: "¿Eliminar la ejecución del benchmark?",
      deleteDescription:
        "Esto eliminará permanentemente los resultados del benchmark y todos los datos por muestra.",
      deleteBulkTitle: "¿Eliminar las ejecuciones seleccionadas?",
      deleteBulkDescription:
        "Esto eliminará permanentemente {count} ejecuciones de benchmark y todos sus datos por muestra.",
      failedToLoad: "No se pudo cargar el historial de benchmarks",
      failedToLoadDetail: "No se pudieron cargar los detalles de la ejecución",
      searchPlaceholder: "Buscar por tarea o modelo...",
      noMatches: "No hay ejecuciones que coincidan",
      selectRun: "Seleccionar ejecución de benchmark",
      sortDateDesc: "Fecha (más reciente)",
      sortDateAsc: "Fecha (más antigua)",
      sortScoreDesc: "Puntuación (de mayor a menor)",
      sortScoreAsc: "Puntuación (de menor a mayor)",
      sortTaskAsc: "Tarea (A-Z)",
      sortModelAsc: "Modelo (A-Z)",
      selected: "{count} seleccionados",
      graph: "Gráfico",
      compare: "Comparar",
      export: "Exportar",
      exportError: "No se pudieron exportar las ejecuciones de benchmark.",
      done: "Listo",
    },
    graph: {
      title: "Graficar resultados de benchmarks",
      description: "Configura y genera un gráfico comparativo a partir de las ejecuciones seleccionadas.",
      orderLabel: "Orden de las ejecuciones (usa las flechas para reordenar):",
      ...
      height: "Alto (in)",
      theme: "Tema",
      themeUnslothDark: "Unsloth oscuro",
      dark: "Oscuro",
      light: "Claro",
      themeGgplot: "ggplot",
      ...
      customThemePlaceholder: "nombre de estilo de matplotlib",
      bar: "Barras",
      line: "Línea",
      ...
      generating: "Generando gráfico...",
    },
    compare: {
      title: "Comparar ejecuciones de benchmark",
      description: "Comparación en paralelo de {count} ejecuciones de benchmark.",
      loading: "Cargando detalles... ({loaded}/{total})",
      sampleSummary: "Resultados de muestras",
      metricBreakdown: "Comparación de métricas",
      metric: "Métrica",
      failedToLoad: "No se pudieron cargar los detalles de la ejecución",
    },
    guide: {
      step1: "Selecciona un modelo para evaluar",
      step2: "Ejecuta el benchmark",
      step3: "Revisa los resultados",
    },
  },
  composerSettings: {
