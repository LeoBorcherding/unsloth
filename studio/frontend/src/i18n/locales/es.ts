...
export const es = {
  ...
  settings: {
    ...
    library: {
      ...
      medium: "Mediano",
      large: "Grande",
      imageLayout: "Tarjetas de imagen",
      imageLayoutDescription: "Mantener la forma de cada imagen o recortarlas en cuadrados iguales.",
      masonry: "Forma original",
      square: "Cuadrada",
      showCardDates: "Mostrar fechas en las tarjetas",
      showCardDatesDescription: "Muestra cuándo cambió cada archivo por última vez.",
      browsingSection: "Navegación",
      startTab: "Abrir en",
      startTabDescription: "La pestaña con la que se abre la Biblioteca.",
      suggested: "Sugeridos",
      all: "Todo",
      sort: "Ordenar por",
      sortDescription: "Orden de archivos y carpetas. Sugeridos siempre muestra los más recientes.",
      recent: "Más recientes",
      oldest: "Más antiguos",
      name: "Nombre",
      suggestedLimit: "Elementos sugeridos",
      suggestedLimitDescription: "Cuántos archivos recientes muestra Sugeridos.",
      tabAuto: "Cuando tengan archivos",
      tabAlways: "Siempre",
      contentSection: "Contenido",
      contentDescription: "Elige qué muestra la Biblioteca. Los archivos ocultos no se eliminan.",
      showChatAttachments: "Adjuntos de chat",
      showChatAttachmentsDescription: "Archivos que adjuntaste a los chats.",
      showChatToolFiles: "Archivos de herramientas del chat",
      ...
      reset: "Restablecer ajustes de la Biblioteca",
      resetDescription: "Devuelve cada opción anterior a su valor predeterminado.",
      resetButton: "Restablecer",
      resetDone: "Ajustes de la Biblioteca restablecidos",
      storageSection: "Almacenamiento",
      storageDescription: "Abre una categoría para ver sus archivos de mayor a menor y elimina lo que ya no necesites.",
      ...
      locationMoveFailed: "No se pudo mover {name}",
      locationFree: "{free} libres en esta unidad",
      locationUnavailable: "No disponible. Vuelve a conectar su unidad o restablece la carpeta.",
      locationResetUnavailableTitle: "¿Restablecer {name}?",
      locationResetUnavailableDescription: "Su unidad no está conectada. Los archivos de {path} se quedan en esa unidad y no aparecerán en la Biblioteca hasta que los vuelvas a mover.",
      locationLeftBehind: "Los archivos de {path} se quedan en esa unidad.",
      dataStorage: "Almacenamiento de la biblioteca",
      manageStorage: "Administrar almacenamiento",
      categoryImages: "Imágenes",
      categoryVideos: "Videos",
      categoryFineTunes: "Ajustes finos",
      itemCountOne: "1 elemento",
      itemCount: "{count} elementos",
      tabsSection: "Pestañas",
      tabsDescription: "Elige qué pestañas muestra la Biblioteca. Una pestaña abierta desde un enlace sigue apareciendo.",
      tabHidden: "Oculta",
      lastVisited: "Última visitada",
    },
    tabs: {
      accounts: "Cuentas",
      general: "General",
    ...
    apiKeys: {
      linkedInstances: {
        title: "Instancias vinculadas",
        description: "Sirve modelos de otras instancias de Unsloth, como una sesión de Colab o WSL, a través de esta API con una sola clave. Aparecen como @nombre/modelo.",
        statusNone: "Ninguna vinculada",
        statusOnline: "{online} de {total} en línea",
        ...
        formHint: "Crea una clave en la otra instancia en Ajustes → API. http simple funciona en este equipo y en tu LAN; las URL públicas necesitan https.",
        link: "Vincular",
        linking: "Vinculando…",
        checking: "Comprobando…",
        ...
        copyPrefix: "Copiar prefijo del modelo",
        copyId: "Copiar id del modelo",
        remove: "Quitar",
        loadError: "No se pudieron cargar las instancias vinculadas.",
        saveError: "No se pudo vincular la instancia.",
        edit: "Editar",
        ...
        infoUnsloth: "Unsloth",
        infoVersion: "Versión",
        infoInstall: "Instalación",
        infoUpdates: "Actualizaciones",
        infoUpToDate: "Al día",
        infoUpdateAvailable: "{version} disponible",
        infoUptime: "Tiempo activo",
        infoHardware: "Hardware",
        infoNoGpu: "No se informó ninguna GPU",
        infoCpu: "CPU",
        infoCores: "{count} núcleos",
        infoMemory: "Memoria",
        infoDisk: "Disco",
        ...
        infoError: "No se pudieron leer los detalles de esta instancia.",
      },
      title: "API",
  ...
  library: {
    ...
    empty: {
      suggestedTitle: "Tu biblioteca está vacía",
      suggestedDescription: "Los archivos que subas o crees en los chats aparecen aquí.",
      favoritesTitle: "Aún no hay favoritos",
      favoritesDescription: "Añade archivos a tus favoritos para encontrarlos aquí rápidamente.",
      foldersTitle: "Crea tu primera carpeta",
      foldersDescription: "Crea carpetas para organizar los elementos de tu biblioteca.",
      imagesTitle: "Aún no hay imágenes",
      imagesDescription: "Las imágenes que subas o generes aparecen aquí.",
      ...
      trainModel: "Entrenar un modelo",
      uploadFiles: "Subir archivos",
      dropHere: "o suelta archivos aquí",
      noMatchesTitle: "Sin resultados",
      noMatchesDescription: "Prueba con otra búsqueda o borra los filtros.",
      loadErrorTitle: "No se pudo cargar tu Biblioteca",
      loadErrorFallback: "Algo salió mal.",
    ...
    searchFolder: "Buscar en la carpeta",
    dropToUpload: "Suelta para subir",
    dropToUploadInto: "Suelta para subir a «{folder}»",
    ...
    menu: {
      ...
      noFolder: "Biblioteca (sin carpeta)",
      deleteFolder: "Eliminar carpeta",
    },
    reveal: {
      finder: "Mostrar en el Finder",
      explorer: "Mostrar en el Explorador",
      files: "Mostrar en la carpeta",
    },
    toolbar: {
      filter: "Filtrar",
      source: "Origen",
    ...
    modelKind: {
      ...
      loraExport: "Exportación LoRA",
      mergedExport: "Exportación fusionada",
      ggufExport: "Exportación GGUF",
      model: "Modelo",
    },
    dialog: {
      create: "Crear",
      ...
      deleteManyTitle: "¿Eliminar {count} elementos?",
      deleteManyDescription: "Los archivos se eliminan de donde estén guardados. Lo que haya dentro de una carpeta eliminada sube un nivel.",
      deleteFolderIntoParent: "Todo su contenido se mueve a «{folder}». No se elimina ningún archivo.",
      deleteFolderIntoLibrary: "Todo su contenido se mueve a tu Biblioteca. No se elimina ningún archivo.",
      deleteUpload: "Esto elimina el archivo de forma permanente.",
      deleteAttachment: "También se quitará del chat al que estaba adjunto.",
      deleteImage: "También se quitará de tu galería de Imágenes.",
      deleteVideo: "También se quitará de tu galería de Vídeo.",
      deleteAudio: "También se quitará de tu galería de Audio.",
      deleteSandbox: "También se quitará del chat que lo creó.",
      deleteModel: "Esto elimina el modelo del disco de forma permanente.",
      unsavedTitle: "Tus cambios no se guardaron",
      unsavedDescription: "{reason} Vuelve a intentarlo o descarta los cambios para cerrar el archivo.",
    ...
    preview: {
      ...
      viewOriginalChat: "Ver el chat original",
      viewInImages: "Ver en Imágenes",
      viewInVideo: "Ver en Vídeo",
      viewInAudio: "Ver en Audio",
      ...
      tooLargeToPreview: "Este archivo es demasiado grande para previsualizarlo aquí. Descárgalo para abrirlo.",
      ...
      location: "Ubicación",
      unknown: "Desconocido",
      readOnlyUtf16: "Este archivo no es texto UTF-16 válido, así que aquí se abre en modo de solo lectura.",
      readOnlyNotUtf8: "Este archivo no es texto UTF-8, así que aquí se abre en modo de solo lectura. Es posible que algunos caracteres no se muestren correctamente.",
    },
    viewer: {
      scale: "Escala",
      fit: "Ajustar",
      moreActionsImage: "Más acciones para esta imagen",
      moreActionsVideo: "Más acciones para este vídeo",
      moreActionsClip: "Más acciones para este clip",
      moreActionsFile: "Más acciones para este archivo",
      openImage: "Abrir imagen",
      openImageNamed: "Abrir imagen: {prompt}",
    ...
    project: {
      ...
      alreadyIn: "Ya está en {project}",
      addedTo: "Añadido a {project}",
      createAndAdd: "Crear y añadir",
      addFailedImage: "No se pudo añadir la imagen al proyecto",
      addFailedVideo: "No se pudo añadir el vídeo al proyecto",
      addFailedClip: "No se pudo añadir el clip al proyecto",
      addFailedFile: "No se pudo añadir el archivo al proyecto",
      newProjectImage: "Añadir imagen a un nuevo proyecto",
      newProjectVideo: "Añadir vídeo a un nuevo proyecto",
      newProjectClip: "Añadir clip a un nuevo proyecto",
      newProjectFile: "Añadir archivo a un nuevo proyecto",
    },
    toast: {
      missingItem: "Ese archivo ya no está en la Biblioteca",
      moveFailed: "No se pudo mover",
      movedToFolder: "Movido a {folder}",
      movedToLibrary: "Movido a la Biblioteca",
      folderFallback: "carpeta",
      favoritesFailed: "No se pudieron actualizar los favoritos",
      addedToFavorites: "Añadido a Favoritos",
      removedFromFavorites: "Quitado de Favoritos",
      uploadingOne: "Subiendo {name}…",
      uploadingMany: "Subiendo {count} archivos…",
      uploadedOne: "Archivo subido",
      uploadedMany: "{count} archivos subidos",
      uploadFailed: "Error al subir",
      uploadTooLarge: "{name} supera los 512 MB.",
      readDropsFailed: "No se pudieron leer los archivos soltados",
      createNoteFailed: "No se pudo crear la nota",
      renameFailed: "No se pudo renombrar",
      createFolderFailed: "No se pudo crear la carpeta",
      signedOutBeforeFolder: "Se cerró la sesión antes de crear la carpeta.",
      signedOutBeforeSave: "Se cerró la sesión antes de guardar el cambio.",
      signedOutBeforeUpload: "Se cerró la sesión antes de terminar la subida.",
      deleteFailed: "No se pudieron eliminar algunos elementos",
      saveFailed: "No se pudo guardar",
      saveNoteFirst: "Guarda primero la nota.",
      revealFailed: "No se pudo abrir el gestor de archivos",
      downloadFailed: "No se pudo descargar {name}",
      downloadManyFailed: "No se pudieron descargar los archivos",
      downloadingMany: "Descargando {count} archivos",
      downloadingManyDescription: "Si tu navegador lo pide, permite que este sitio descargue varios archivos.",
      preparingMany: "Preparando {count} archivos…",
      zipFileName: "Archivos de la Biblioteca",
      nothingToChat: "Todavía no hay nada sobre lo que chatear",
      emptyFolder: "Esta carpeta no tiene archivos.",
      tooLargeOne: "{name} es demasiado grande para adjuntarlo",
      tooLargeMany: "Estos archivos son demasiado grandes para adjuntarlos",
      attachedOne: "{count} archivo adjuntado",
      ...
      imageTooLarge: "Esta imagen es demasiado grande para adjuntarla",
      videoTooLarge: "Este vídeo es demasiado grande para adjuntarlo",
      attachmentLimit: "Los adjuntos del chat tienen un límite de {size} MB.",
      attachingImage: "Adjuntando la imagen…",
      attachingVideo: "Adjuntando el vídeo…",
      readImageFailed: "No se pudo leer la imagen ({status}).",
