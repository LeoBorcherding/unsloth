...
export const de = {
  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        title: "Verknüpfte Instanzen",
        description: "Stellt Modelle anderer Unsloth-Instanzen, etwa einer Colab- oder WSL-Sitzung, über diese API mit einem Schlüssel bereit. Sie erscheinen als @name/model.",
        statusNone: "Keine verknüpft",
        statusOnline: "{online} von {total} online",
        ...
        formHint: "Erstelle auf der anderen Instanz unter Einstellungen → API einen Schlüssel. Einfaches http funktioniert auf diesem Rechner und im LAN; öffentliche URLs brauchen https.",
        link: "Verknüpfen",
        ...
        copyPrefix: "Modellpräfix kopieren",
        copyId: "Modell-ID kopieren",
        remove: "Entfernen",
        loadError: "Verknüpfte Instanzen konnten nicht geladen werden.",
        saveError: "Die Instanz konnte nicht verknüpft werden.",
        edit: "Bearbeiten",
        apiKeyKeep: "Leer lassen zum Behalten",
        removeTitle: "@{name} entfernen?",
        removeDescription: "Anfragen an @{name}/… funktionieren dann nicht mehr, und der gespeicherte API-Schlüssel wird von diesem Rechner gelöscht. Die andere Instanz bleibt unverändert.",
        details: "Details",
        ...
        infoUpdates: "Updates",
        infoUpToDate: "Aktuell",
        infoUpdateAvailable: "{version} verfügbar",
        infoUptime: "Laufzeit",
        infoHardware: "Hardware",
        infoNoGpu: "Keine GPU gemeldet",
        infoCpu: "CPU",
        infoCores: "{count} Kerne",
        infoMemory: "Arbeitsspeicher",
        ...
        infoCpuOnly: "Nur CPU",
        infoModels: "Modelle",
        infoNoModels: "Auf dieser Instanz gibt es noch keine Modelle.",
        infoTunnel: "Cloudflare-Tunnel",
        infoLoopback: "Dieser Rechner",
        infoLan: "Lokales Netzwerk",
        infoPublic: "Öffentliche URL",
        infoUnknown: "Nicht gemeldet",
        infoError: "Die Details dieser Instanz konnten nicht gelesen werden.",
      },
      title: "API",
