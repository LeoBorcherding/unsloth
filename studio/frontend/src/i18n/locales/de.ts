  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        ...
        description: "Stellt Modelle anderer Unsloth Studio-Instanzen, etwa einer Colab- oder WSL-Sitzung, über die API dieses Servers mit einem Schlüssel bereit. Ihre Modelle erscheinen als @name/model.",
        name: "Name",
        ...
        add: "Instanz verknüpfen",
        adding: "Wird verknüpft...",
        empty: "Noch keine verknüpften Instanzen.",
        checking: "Wird geprüft...",
        offline: "Offline",
