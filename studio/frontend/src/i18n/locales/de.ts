...
export const de = {
  benchmark: {
    pageTitle: "Modell benchmarken",
    pageDescription: "Modellleistung und Qualitätsmetriken auswerten",
    configSectionTitle: "Benchmark-Konfiguration",
    configSectionDescription: "Wähle ein Modell zum Benchmarken aus",
    modelLabel: "Modell",
    loadingCheckpoints: "Checkpoints werden geladen…",
    scanningLocalModels: "Lokale Modelle werden durchsucht...",
    ...
    taskLabel: "Benchmark",
    loadingTasks: "Benchmarks werden geladen...",
    searchTaskPlaceholder: "Benchmarks suchen...",
    noTasksFound: "Keine Benchmarks gefunden",
    ...
    fewshotNotSupported: "Für diese Aufgabe nicht unterstützt",
    historySectionTitle: "Benchmark-Verlauf",
    historySectionDescription: "Ergebnisse früherer Benchmark-Läufe anzeigen",
    history: {
      title: "Benchmark-Verlauf",
      run: "Lauf",
      runs: "Läufe",
      ...
      perSampleResults: "Ergebnisse pro Beispiel ({count})",
      noSampleData: "Keine Daten pro Beispiel verfügbar",
      noResults: "Noch keine Benchmark-Ergebnisse",
      noResponse: "(keine Antwort)",
      noValidResponse: "(keine gültige Antwort)",
      question: "Frage:",
      expected: "Erwartet:",
      got: "Erhalten:",
      rawOutput: "Rohausgabe:",
      deleteTitle: "Benchmark-Lauf löschen?",
      deleteDescription:
        "Dadurch werden die Benchmark-Ergebnisse und alle Daten pro Beispiel dauerhaft gelöscht.",
      deleteBulkTitle: "Ausgewählte Benchmark-Läufe löschen?",
      deleteBulkDescription:
        "Dadurch werden {count} Benchmark-Läufe und alle zugehörigen Daten pro Beispiel dauerhaft gelöscht.",
      failedToLoad: "Benchmark-Verlauf konnte nicht geladen werden",
      failedToLoadDetail: "Details zum Lauf konnten nicht geladen werden",
      searchPlaceholder: "Nach Aufgabe oder Modell suchen...",
      noMatches: "Keine passenden Benchmark-Läufe",
      selectRun: "Benchmark-Lauf auswählen",
      sortDateDesc: "Datum (neueste zuerst)",
      sortDateAsc: "Datum (älteste zuerst)",
      sortScoreDesc: "Punktzahl (hoch zu niedrig)",
      sortScoreAsc: "Punktzahl (niedrig zu hoch)",
      sortTaskAsc: "Aufgabe (A-Z)",
      sortModelAsc: "Modell (A-Z)",
      selected: "{count} ausgewählt",
      graph: "Diagramm",
      compare: "Vergleichen",
      export: "Exportieren",
      exportError: "Benchmark-Läufe konnten nicht exportiert werden.",
      done: "Fertig",
    },
    graph: {
      title: "Benchmark-Ergebnisse als Diagramm darstellen",
      description: "Konfiguriere und erstelle ein Vergleichsdiagramm aus den ausgewählten Benchmark-Läufen.",
      orderLabel: "Reihenfolge der Läufe (mit den Pfeilen neu anordnen):",
      ...
      height: "Höhe (in)",
      theme: "Design",
      themeUnslothDark: "Unsloth Dunkel",
      dark: "Dunkel",
      light: "Hell",
      themeGgplot: "ggplot",
      ...
      customThemePlaceholder: "matplotlib-Stilname",
      bar: "Balken",
      line: "Linie",
    ...
    compare: {
      title: "Benchmark-Läufe vergleichen",
      description: "Direkter Vergleich von {count} Benchmark-Läufen.",
      loading: "Details werden geladen... ({loaded}/{total})",
      sampleSummary: "Ergebnisse pro Beispiel",
      metricBreakdown: "Metrikvergleich",
      metric: "Metrik",
      failedToLoad: "Details zum Lauf konnten nicht geladen werden",
    },
    guide: {
      step1: "Wähle ein Modell zum Benchmarken aus",
      step2: "Starte den Benchmark",
