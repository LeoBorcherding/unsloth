...
export const ko = {
  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        title: "연결된 인스턴스",
        description: "Colab 또는 WSL 세션 같은 다른 Unsloth 인스턴스의 모델을 이 API에서 키 하나로 제공합니다. @name/model 형식으로 표시됩니다.",
        statusNone: "연결 없음",
        statusOnline: "{total}개 중 {online}개 온라인",
        add: "인스턴스 추가",
        name: "이름",
        ...
        formHint: "다른 인스턴스의 설정 → API에서 키를 만드세요. 일반 http는 이 컴퓨터와 LAN에서만 되며, 공개 URL에는 https가 필요합니다.",
        link: "연결",
        linking: "연결 중…",
        checking: "확인 중…",
        offline: "오프라인",
        ...
        checkAgain: "다시 확인",
        actions: "{name} 작업",
        copyPrefix: "모델 접두사 복사",
        copyId: "모델 ID 복사",
        remove: "제거",
        loadError: "연결된 인스턴스를 불러오지 못했습니다.",
        saveError: "인스턴스를 연결하지 못했습니다.",
        edit: "편집",
        ...
        infoUpdates: "업데이트",
        infoUpToDate: "최신 상태",
        infoUpdateAvailable: "{version} 사용 가능",
        infoUptime: "가동 시간",
        infoHardware: "하드웨어",
        infoNoGpu: "보고된 GPU 없음",
        infoCpu: "CPU",
        infoCores: "{count}코어",
        infoMemory: "메모리",
        infoDisk: "디스크",
        ...
        infoPublic: "공개 URL",
        infoUnknown: "보고되지 않음",
        infoError: "이 인스턴스의 세부 정보를 읽을 수 없습니다.",
      },
      title: "API",
