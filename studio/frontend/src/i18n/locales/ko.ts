...
export const ko = {
  benchmark: {
    pageTitle: "모델 벤치마크",
    pageDescription: "모델 성능과 품질 지표를 평가합니다",
    configSectionTitle: "벤치마크 설정",
    configSectionDescription: "벤치마크할 모델을 선택하세요",
    modelLabel: "모델",
    loadingCheckpoints: "체크포인트를 불러오는 중…",
    scanningLocalModels: "로컬 모델을 검색하는 중...",
    failedToLoadLocalModels: "로컬 모델을 불러오지 못했습니다",
    loadingModel: "모델을 불러오는 중…",
    downloadingModel: "모델을 다운로드하는 중…",
    hfCache: "HF 캐시",
    customFolders: "사용자 지정 폴더",
    localDir: "로컬 디렉터리",
    taskLabel: "벤치마크",
    loadingTasks: "벤치마크를 불러오는 중...",
    searchTaskPlaceholder: "벤치마크 검색...",
    noTasksFound: "벤치마크를 찾을 수 없습니다",
    runButton: "벤치마크 실행",
    ...
    runPanel: {
      ...
      connecting: "연결하는 중...",
      complete: "벤치마크가 완료되었습니다",
      failed: "벤치마크가 실패했습니다",
      cancelled: "벤치마크가 취소되었습니다",
    },
    fewshotNotSupported: "이 작업에서는 지원되지 않습니다",
    historySectionTitle: "벤치마크 기록",
    historySectionDescription: "지난 벤치마크 실행 결과를 확인합니다",
    history: {
      title: "벤치마크 기록",
      run: "회",
      runs: "회",
      ...
      perSampleResults: "샘플별 결과 ({count})",
      noSampleData: "샘플별 데이터가 없습니다",
      noResults: "아직 벤치마크 결과가 없습니다",
      noResponse: "(응답 없음)",
      noValidResponse: "(유효한 응답 없음)",
      question: "질문:",
      expected: "기대값:",
      got: "결과:",
      rawOutput: "원본 출력:",
      deleteTitle: "벤치마크 실행을 삭제할까요?",
      deleteDescription:
        "벤치마크 결과와 모든 샘플별 데이터가 영구적으로 삭제됩니다.",
      deleteBulkTitle: "선택한 벤치마크 실행을 삭제할까요?",
      deleteBulkDescription:
        "벤치마크 실행 {count}개와 모든 샘플별 데이터가 영구적으로 삭제됩니다.",
      failedToLoad: "벤치마크 기록을 불러오지 못했습니다",
      failedToLoadDetail: "실행 세부 정보를 불러오지 못했습니다",
      searchPlaceholder: "작업 또는 모델로 검색...",
      noMatches: "일치하는 벤치마크 실행이 없습니다",
      selectRun: "벤치마크 실행 선택",
      sortDateDesc: "날짜 (최신순)",
      sortDateAsc: "날짜 (오래된순)",
      sortScoreDesc: "점수 (높은순)",
      sortScoreAsc: "점수 (낮은순)",
      sortTaskAsc: "작업 (A-Z)",
      sortModelAsc: "모델 (A-Z)",
      ...
      compare: "비교",
      export: "내보내기",
      exportError: "벤치마크 실행을 내보내지 못했습니다.",
      done: "완료",
    },
    graph: {
      title: "벤치마크 결과 그래프",
      description: "선택한 벤치마크 실행으로 비교 차트를 설정하고 생성합니다.",
      orderLabel: "실행 순서 (화살표로 순서 변경):",
      chartType: "차트 종류",
      metric: "지표",
      accuracy: "정확도",
      width: "너비 (인치)",
      height: "높이 (인치)",
      theme: "테마",
      themeUnslothDark: "Unsloth 다크",
      dark: "다크",
      light: "라이트",
      themeGgplot: "ggplot",
      themeFiveThirtyEight: "FiveThirtyEight",
      themeBmh: "BMH",
      themeGrayscale: "그레이스케일",
      themeSeaborn: "Seaborn",
      themeSeabornDarkgrid: "Seaborn 다크 그리드",
      themeCustom: "사용자 지정…",
      customThemePlaceholder: "matplotlib 스타일 이름",
      bar: "막대형",
      line: "선형",
      groupedBar: "그룹 막대형",
      radar: "레이더형",
      generate: "생성",
      download: "PNG 다운로드",
      generating: "차트를 생성하는 중...",
    },
    compare: {
      title: "벤치마크 실행 비교",
      description: "벤치마크 실행 {count}개를 나란히 비교합니다.",
      loading: "세부 정보를 불러오는 중... ({loaded}/{total})",
      sampleSummary: "샘플 결과",
      metricBreakdown: "지표 비교",
      metric: "지표",
      failedToLoad: "실행 세부 정보를 불러오지 못했습니다",
    },
    guide: {
      step1: "벤치마크할 모델을 선택하세요",
      step2: "벤치마크를 실행하세요",
      step3: "결과를 확인하세요",
    },
  },
