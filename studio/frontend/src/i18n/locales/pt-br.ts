...
export const ptBR = {
  benchmark: {
    pageTitle: "Avaliar Modelo",
    pageDescription: "Avalie o desempenho e as métricas de qualidade do modelo",
    configSectionTitle: "Configuração do Benchmark",
    configSectionDescription: "Selecione um modelo para avaliar",
    modelLabel: "Modelo",
    loadingCheckpoints: "Carregando checkpoints…",
    scanningLocalModels: "Verificando modelos locais...",
    ...
    taskLabel: "Benchmark",
    loadingTasks: "Carregando benchmarks...",
    searchTaskPlaceholder: "Buscar benchmarks...",
    noTasksFound: "Nenhum benchmark encontrado",
    ...
    runPanel: {
      ...
      complete: "Benchmark concluído",
      failed: "Falha no benchmark",
      cancelled: "Benchmark cancelado",
    },
    fewshotNotSupported: "Não suportado para esta tarefa",
    historySectionTitle: "Histórico de Benchmarks",
    historySectionDescription: "Veja os resultados de execuções de benchmark anteriores",
    history: {
      ...
      perSampleResults: "Resultados por amostra ({count})",
      noSampleData: "Nenhum dado por amostra disponível",
      noResults: "Ainda não há resultados de benchmark",
      noResponse: "(sem resposta)",
      noValidResponse: "(sem resposta válida)",
      question: "Pergunta:",
      expected: "Esperado:",
      got: "Obtido:",
      rawOutput: "Saída bruta:",
      deleteTitle: "Excluir execução de benchmark?",
      deleteDescription:
        "Isso excluirá permanentemente os resultados do benchmark e todos os dados por amostra.",
      deleteBulkTitle: "Excluir as execuções de benchmark selecionadas?",
      deleteBulkDescription:
        "Isso excluirá permanentemente {count} execuções de benchmark e todos os seus dados por amostra.",
      failedToLoad: "Falha ao carregar o histórico de benchmarks",
      failedToLoadDetail: "Falha ao carregar os detalhes da execução",
      searchPlaceholder: "Buscar por tarefa ou modelo...",
      noMatches: "Nenhuma execução de benchmark correspondente",
      selectRun: "Selecionar execução de benchmark",
      sortDateDesc: "Data (mais recente)",
      sortDateAsc: "Data (mais antiga)",
      sortScoreDesc: "Pontuação (maior para menor)",
      sortScoreAsc: "Pontuação (menor para maior)",
      sortTaskAsc: "Tarefa (A-Z)",
      sortModelAsc: "Modelo (A-Z)",
      selected: "{count} selecionados",
      graph: "Gráfico",
      compare: "Comparar",
      export: "Exportar",
      exportError: "Falha ao exportar as execuções de benchmark.",
      done: "Concluído",
    },
    graph: {
      title: "Gerar Gráfico de Resultados de Benchmark",
      description: "Configure e gere um gráfico comparativo a partir das execuções de benchmark selecionadas.",
      orderLabel: "Ordem das execuções (use as setas para reordenar):",
      ...
      height: "Altura (pol.)",
      theme: "Tema",
      themeUnslothDark: "Unsloth Escuro",
      dark: "Escuro",
      light: "Claro",
      themeGgplot: "ggplot",
      themeFiveThirtyEight: "FiveThirtyEight",
      themeBmh: "BMH",
      themeGrayscale: "Escala de Cinza",
      themeSeaborn: "Seaborn",
      themeSeabornDarkgrid: "Seaborn Grade Escura",
      themeCustom: "Personalizado…",
      customThemePlaceholder: "nome do estilo do matplotlib",
      bar: "Barra",
      line: "Linha",
      ...
      generate: "Gerar",
      download: "Baixar PNG",
      generating: "Gerando gráfico...",
    },
    compare: {
      title: "Comparar Execuções de Benchmark",
      description: "Comparação lado a lado de {count} execuções de benchmark.",
      loading: "Carregando detalhes... ({loaded}/{total})",
      sampleSummary: "Resultados das amostras",
      metricBreakdown: "Comparação de métricas",
      metric: "Métrica",
      failedToLoad: "Falha ao carregar os detalhes da execução",
    },
    guide: {
      step1: "Selecione um modelo para avaliar",
      step2: "Execute o benchmark",
      step3: "Revise os resultados",
    },
  },
  composerSettings: {
