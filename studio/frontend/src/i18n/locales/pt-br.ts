  ...
  settings: {
    ...
    apiKeys: {
      linkedInstances: {
        ...
        description: "Sirva modelos de outras instâncias do Unsloth Studio, como uma sessão do Colab ou WSL, pela API deste servidor com uma única chave. Os modelos aparecem como @nome/modelo.",
        name: "Nome",
        ...
        add: "Vincular instância",
        adding: "Vinculando...",
        empty: "Nenhuma instância vinculada ainda.",
        checking: "Verificando...",
        offline: "Offline",
