...
export const ptBR = {
  ...
  settings: {
    ...
    library: {
      ...
      medium: "Médio",
      large: "Grande",
      imageLayout: "Cartões de imagem",
      imageLayoutDescription: "Manter o formato de cada imagem ou cortá-las em quadrados iguais.",
      masonry: "Formato original",
      square: "Quadrado",
      showCardDates: "Mostrar datas nos cartões",
      showCardDatesDescription: "Mostra quando cada arquivo foi alterado pela última vez.",
      browsingSection: "Navegação",
      startTab: "Abrir em",
      startTabDescription: "A aba em que a Biblioteca abre.",
      suggested: "Sugeridos",
      all: "Tudo",
      sort: "Ordenar por",
      sortDescription: "Ordem de arquivos e pastas. Sugeridos sempre mostra os mais recentes.",
      recent: "Mais recentes",
      oldest: "Mais antigos",
      name: "Nome",
      suggestedLimit: "Itens sugeridos",
      suggestedLimitDescription: "Quantos arquivos recentes Sugeridos mostra.",
      tabAuto: "Quando houver arquivos",
      tabAlways: "Sempre",
      contentSection: "Conteúdo",
      contentDescription: "Escolha o que a Biblioteca mostra. Arquivos ocultos não são excluídos.",
      showChatAttachments: "Anexos de chat",
      showChatAttachmentsDescription: "Arquivos que você anexou aos chats.",
      showChatToolFiles: "Arquivos de ferramentas do chat",
      ...
      reset: "Redefinir configurações da Biblioteca",
      resetDescription: "Volta cada opção acima ao padrão.",
      resetButton: "Redefinir",
      resetDone: "Configurações da Biblioteca redefinidas",
      storageSection: "Armazenamento",
      storageDescription: "Abra uma categoria para ver os arquivos do maior para o menor e exclua o que não precisa mais.",
      ...
      locationMoveFailed: "Não foi possível mover {name}",
      locationFree: "{free} livres nesta unidade",
      locationUnavailable: "Indisponível. Reconecte a unidade ou redefina a pasta.",
      locationResetUnavailableTitle: "Redefinir {name}?",
      locationResetUnavailableDescription: "A unidade não está conectada. Os arquivos em {path} continuam nela e não aparecerão na Biblioteca até que você os mova de volta.",
      locationLeftBehind: "Os arquivos em {path} continuam nessa unidade.",
      dataStorage: "Armazenamento da biblioteca",
      ...
      tabsSection: "Abas",
      tabsDescription: "Escolha quais abas a Biblioteca mostra. Uma aba aberta por um link continua aparecendo.",
      tabHidden: "Oculta",
    ...
    apiKeys: {
      linkedInstances: {
        title: "Instâncias vinculadas",
        description: "Sirva modelos de outras instâncias do Unsloth, como uma sessão do Colab ou WSL, por esta API com uma única chave. Eles aparecem como @nome/modelo.",
        statusNone: "Nenhuma vinculada",
        statusOnline: "{online} de {total} online",
        ...
        formHint: "Crie uma chave na outra instância em Configurações → API. http simples funciona nesta máquina e na sua LAN; URLs públicas precisam de https.",
        link: "Vincular",
        linking: "Vinculando…",
        checking: "Verificando…",
        offline: "Offline",
        ...
        copyPrefix: "Copiar prefixo do modelo",
        ...
        infoUnsloth: "Unsloth",
        infoVersion: "Versão",
        infoInstall: "Instalação",
        infoUpdates: "Atualizações",
        infoUpToDate: "Atualizado",
        infoUpdateAvailable: "{version} disponível",
        infoUptime: "Tempo ativo",
        infoHardware: "Hardware",
        infoNoGpu: "Nenhuma GPU informada",
        infoCpu: "CPU",
        ...
        infoError: "Não foi possível ler os detalhes desta instância.",
      },
      title: "API",
      description:
  ...
  library: {
    tabs: {
      ariaLabel: "Seções da Biblioteca",
      suggested: "Sugestões",
      favorites: "Favoritos",
      folders: "Pastas",
      images: "Imagens",
    ...
    empty: {
      suggestedTitle: "Sua biblioteca está vazia",
      suggestedDescription: "Os arquivos que você envia ou cria nos chats aparecem aqui.",
      favoritesTitle: "Nenhum favorito ainda",
      favoritesDescription: "Adicione arquivos aos favoritos para encontrá-los aqui rapidamente.",
      foldersTitle: "Crie sua primeira pasta",
      foldersDescription: "Crie pastas para organizar os itens da sua biblioteca.",
      imagesTitle: "Nenhuma imagem ainda",
      imagesDescription: "As imagens que você envia ou gera aparecem aqui.",
      videosTitle: "Nenhum vídeo ainda",
      videosDescription: "Os vídeos que você envia ou gera aparecem aqui.",
      ...
      trainModel: "Treinar um modelo",
      uploadFiles: "Enviar arquivos",
      dropHere: "ou solte arquivos aqui",
      noMatchesTitle: "Nenhum resultado",
      noMatchesDescription: "Tente outra busca ou limpe os filtros.",
      loadErrorTitle: "Não foi possível carregar sua Biblioteca",
      loadErrorFallback: "Algo deu errado.",
    ...
    searchFolder: "Buscar na pasta",
    dropToUpload: "Solte para enviar",
    dropToUploadInto: 'Solte para enviar para "{folder}"',
    ...
    menu: {
      ...
      noFolder: "Biblioteca (sem pasta)",
      deleteFolder: "Excluir pasta",
    },
    reveal: {
      finder: "Mostrar no Finder",
      explorer: "Mostrar no Explorer",
      files: "Mostrar na pasta",
    },
    toolbar: {
      filter: "Filtrar",
      source: "Origem",
    ...
    modelKind: {
      ...
      loraExport: "Exportação LoRA",
      mergedExport: "Exportação mesclada",
      ggufExport: "Exportação GGUF",
      model: "Modelo",
    },
    dialog: {
      create: "Criar",
      ...
      deleteManyTitle: "Excluir {count} itens?",
      deleteManyDescription: "Os arquivos são excluídos de onde estão armazenados. O conteúdo de uma pasta excluída sobe um nível.",
      deleteFolderIntoParent: 'Todo o conteúdo é movido para "{folder}". Nenhum arquivo é excluído.',
      deleteFolderIntoLibrary: "Todo o conteúdo é movido para sua Biblioteca. Nenhum arquivo é excluído.",
      deleteUpload: "Isso exclui o arquivo permanentemente.",
      deleteAttachment: "Ele também é removido do chat ao qual estava anexado.",
      deleteImage: "Ele também é removido da sua galeria de Imagens.",
      deleteVideo: "Ele também é removido da sua galeria de Vídeo.",
      deleteAudio: "Ele também é removido da sua galeria de Áudio.",
      deleteSandbox: "Ele também é removido do chat que o criou.",
      deleteModel: "Isso exclui o modelo do disco permanentemente.",
      unsavedTitle: "Suas alterações não foram salvas",
    ...
    preview: {
      code: "Código",
      preview: "Prévia",
      viewOriginalChat: "Ver chat original",
      viewInImages: "Ver em Imagens",
      viewInVideo: "Ver em Vídeo",
      ...
      tooLargeToPreview: "Este arquivo é grande demais para ser visualizado aqui. Baixe-o para abri-lo.",
      ...
      location: "Local",
      unknown: "Desconhecido",
      readOnlyUtf16: "Este arquivo não é um texto UTF-16 válido, por isso abre aqui somente para leitura.",
      readOnlyNotUtf8: "Este arquivo não é texto UTF-8, por isso abre aqui somente para leitura. Alguns caracteres podem não aparecer corretamente.",
    },
    viewer: {
      scale: "Escala",
      fit: "Ajustar",
      ...
      moreActionsFile: "Mais ações para este arquivo",
      openImage: "Abrir imagem",
      openImageNamed: "Abrir imagem: {prompt}",
      openVideo: "Abrir vídeo",
      untitledImage: "Imagem sem título",
    ...
    project: {
      ...
      alreadyIn: "Já está em {project}",
      addedTo: "Adicionado a {project}",
      createAndAdd: "Criar e adicionar",
      addFailedImage: "Falha ao adicionar a imagem ao projeto",
      addFailedVideo: "Falha ao adicionar o vídeo ao projeto",
      addFailedClip: "Falha ao adicionar o clipe ao projeto",
      addFailedFile: "Falha ao adicionar o arquivo ao projeto",
      newProjectImage: "Adicionar imagem a um novo projeto",
      newProjectVideo: "Adicionar vídeo a um novo projeto",
      newProjectClip: "Adicionar clipe a um novo projeto",
      newProjectFile: "Adicionar arquivo a um novo projeto",
    },
    toast: {
      missingItem: "Esse arquivo não está mais na Biblioteca",
      moveFailed: "Não foi possível mover",
      movedToFolder: "Movido para {folder}",
      movedToLibrary: "Movido para a Biblioteca",
      folderFallback: "pasta",
      favoritesFailed: "Não foi possível atualizar os favoritos",
      addedToFavorites: "Adicionado aos Favoritos",
      removedFromFavorites: "Removido dos Favoritos",
      uploadingOne: "Enviando {name}…",
      uploadingMany: "Enviando {count} arquivos…",
      uploadedOne: "Arquivo enviado",
      uploadedMany: "{count} arquivos enviados",
      uploadFailed: "Falha no envio",
      uploadTooLarge: "{name} tem mais de 512 MB.",
      readDropsFailed: "Não foi possível ler os arquivos soltos",
      createNoteFailed: "Não foi possível criar a nota",
      renameFailed: "Não foi possível renomear",
      createFolderFailed: "Não foi possível criar a pasta",
      signedOutBeforeFolder: "A sessão foi encerrada antes de a pasta ser criada.",
      signedOutBeforeSave: "A sessão foi encerrada antes de a alteração ser salva.",
      signedOutBeforeUpload: "A sessão foi encerrada antes de o envio terminar.",
      deleteFailed: "Não foi possível excluir alguns itens",
      saveFailed: "Não foi possível salvar",
      saveNoteFirst: "Salve a nota primeiro.",
      revealFailed: "Não foi possível abrir o gerenciador de arquivos",
      downloadFailed: "Não foi possível baixar {name}",
      downloadManyFailed: "Não foi possível baixar os arquivos",
      downloadingMany: "Baixando {count} arquivos",
      downloadingManyDescription: "Se o navegador perguntar, permita que este site baixe vários arquivos.",
      preparingMany: "Preparando {count} arquivos…",
      zipFileName: "Arquivos da Biblioteca",
      nothingToChat: "Ainda não há nada para conversar",
      emptyFolder: "Esta pasta não tem arquivos.",
      tooLargeOne: "{name} é grande demais para ser anexado",
      tooLargeMany: "Estes arquivos são grandes demais para serem anexados",
      attachedOne: "{count} arquivo anexado",
      ...
      imageTooLarge: "Esta imagem é grande demais para anexar",
      videoTooLarge: "Este vídeo é grande demais para anexar",
      attachmentLimit: "Os anexos do chat são limitados a {size} MB.",
      attachingImage: "Anexando a imagem…",
      attachingVideo: "Anexando o vídeo…",
      readImageFailed: "Não foi possível ler a imagem ({status}).",
